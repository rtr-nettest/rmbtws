 ...
 *****************************************************************************!*/
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function RMBTTest(e,t){function n(e){void 0!==M&&M===e||(M=e,O=nowMs(),E&&E(e))}function s(e,t,s){var i=(e.test_server_encryption?"wss://":"ws://")+e.test_server_address+":"+e.test_server_port;p.debug(i);var d=function(){return{IGNORE:function(){},CALLGLOBALHANDLER:function(e){e&&p.error("connection closed",e),x(RMBTError.CONNECT_FAILED)},TRYRECONNECT:function(){x(RMBTError.CONNECT_FAILED)}}}();t.onStateEnter(TestState.INIT_DOWN,function(){n(TestState.INIT_DOWN),p.debug(t.id+": start short download"),m=v,a(t,b.pretestDurationMs)}),t.onStateEnter(TestState.PING,function(){n(TestState.PING),p.debug(t.id+": starting ping"),0===t.id?u(t):t.triggerNextState()}),t.onStateEnter(TestState.DOWN,function(){if(n(TestState.DOWN),D.length>0){var s=r(D,b.downloadThreadsLimitsMbit,!1);C=s.numThreads,I&&(m=s.chunkSize),D=[]}t.id<C?c(t,e.test_duration):(t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.triggerNextState())}),t.onStateEnter(TestState.CONNECT_UPLOAD,function(){n(TestState.INIT_UP),t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.socket.close(),o(t,i,e.test_token,d.CALLGLOBALHANDLER)}),t.onStateEnter(TestState.INIT_UP,function(){m=v,l(t,b.pretestDurationMs)}),t.onStateEnter(TestState.UP,function(){if(n(TestState.UP),D.length>0){var s=r(D,b.uploadThreadsLimitsMbit,!0);U=s.numThreads,I&&(m=s.chunkSize),D=[]}t.id<U?T(t,e.test_duration):(t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.socket.readyState!==WebSocket.CLOSED&&t.socket.close(),t.triggerNextState())}),t.onStateEnter(TestState.END,function(){t.socket.readyState!==WebSocket.CLOSED&&t.socket.close(),0===t.id&&s()}),t.setState(TestState.INIT),n(TestState.INIT),o(t,i,e.test_token,d.CALLGLOBALHANDLER)}function o(e,t,n,s){try{e.socket=new WebSocket(t)}catch(e){return void x(RMBTError.SOCKET_INIT_FAILED)}e.socket.binaryType="arraybuffer",e.socket.onerror=s,e.socket.onclose=s,e.socket.onmessage=function(t){if(0===t.data.indexOf("CHUNKSIZE")){var o=t.data.trim().split(" ");4===o.length?(_=parseInt(o[1]),v=parseInt(o[2]),h=parseInt(o[3])):(_=parseInt(o[1]),v=_),p.debug(e.id+": Chunksizes: min "+v+", max: "+h+", default: "+_)}else if(0===t.data.indexOf("RMBTv")){var r=t.data.substring(5).trim();b.client_version=r,0===r.indexOf("1.")?I=!0:0===r.indexOf("0.3")?I=!1:p.warn("unknown server version: "+r)}else"ACCEPT TOKEN QUIT\n"===t.data?e.socket.send("TOKEN "+n+"\n"):"OK\n"===t.data&&e.state===TestState.INIT?p.debug(e.id+": Token accepted"):"ERR\n"===t.data?(s(),p.error("got error msg")):0===t.data.indexOf("ACCEPT GETCHUNKS")&&e.triggerNextState()}}function r(e,t,n){G=e.reduce(function(e,t){return e+t}),p.debug("total: circa "+G/1e3+" KB/sec"),p.debug("total: circa "+8*G/1e6+" MBit/sec");var s=8*G/1e6,o=0;Object.keys(t).forEach(function(e){s>e&&(o=t[e])}),o=Math.min(B,o),p.debug("set number of threads to be used in upcoming speed test to: "+o);var r=G/(1e3/(b.measurementPointsTimespan/2));if(r-=r%1024,r=Math.max(v,r),r=Math.min(h,r),p.debug("calculated chunksize for upcoming speed test "+r/1024+" KB"),n){var a=Number.POSITIVE_INFINITY;Object.keys(y).forEach(function(e){Math.abs(r-e)<Math.abs(r-a)?("string"==typeof e&&(e=parseInt(e)),a=e):(delete y[e],delete L[e])}),r=a,p.debug("fallback to existing chunksize for upcoming speed test "+r/1024+" KB")}return{numThreads:o,chunkSize:r,bytesPerSecs:G}}function a(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=m;!function u(){i(e,o,a,function(i){r+=o*a,p.debug(e.id+": "+i);var d=parseInt(i.substring(5));nowMs()-s>t?(D.push(o*a/(d/1e9)),e.socket.onmessage=n):o<8||!I?(o*=2,u()):(a=Math.min(2*a,h),u())})}()}function i(e,t,n,s){var o=e.socket,r=t,a=m*t,i=0,u=null,d=function(e,t){var n=new Uint8Array(e.length+t.length);return n.set(e,0),n.set(t,e.length),n},c=function(e){if("string"!=typeof e.data){var t=!1;u=null===u?new Uint8Array(e.data):d(u,new Uint8Array(e.data)),i+=e.data.byteLength,u.length===n&&(r--,t=!0),t&&255===u[u.length-1]?(o.onmessage=function(e){var t=e.data;s(t)},o.send("OK\n"),L[n]=u.buffer,u=null):(y.hasOwnProperty(n)||(y[n]=[]),t&&(y[n].length<b.savedChunks&&y[n].push(u.buffer),u=null))}};o.onmessage=c,p.debug(e.id+": downloading "+t+" chunks, "+a/1e3+" KB");var l="GETCHUNKS "+t+(n!==_?" "+n:"")+"\n";o.send(l)}function u(e){var t=e.socket.onmessage,n=b.numPings,s=performance.now();d(e,function o(r){if(e.result.pings.push(r),k.pings=[].concat(_toConsumableArray(e.result.pings)),n===b.numPings-1&&(w.durationPingMs=(e.result.pings[1].timeNs-e.result.pings[0].timeNs)/1e6*b.numPings,p.debug(e.id+": PING phase will take approx "+w.durationPingMs+" ms")),p.debug(e.id+": PING "+r.client+" ns client; "+r.server+" ns server"),n--,b.doPingIntervalMilliseconds>0&&0===n){performance.now()-s<b.doPingIntervalMilliseconds&&(n=1)}if(n>0)e.socket.onmessage=function(t){"ACCEPT GETCHUNKS GETTIME PUT PUTNORESULT PING QUIT\n"===t.data?d(e,o):p.error("unexpected error during ping test")};else{for(var a=[],i=0;i<e.result.pings.length;i++)a.push(e.result.pings[i].client);k.ping_client_median=Math.median(a),k.ping_client_shortest=Math.min.apply(Math,a);for(var u=[],c=0;c<e.result.pings.length;c++)u.push(e.result.pings[c].server);k.ping_server_median=Math.median(u),k.ping_server_shortest=Math.min.apply(Math,u),p.debug(e.id+": median client: "+Math.round(k.ping_client_median/1e3)/1e3+" ms; median server: "+Math.round(k.ping_server_median/1e3)/1e3+" ms"),p.debug(e.id+": shortest client: "+Math.round(k.ping_client_shortest/1e3)/1e3+" ms; shortest server: "+Math.round(k.ping_server_shortest/1e3)/1e3+" ms"),e.socket.onmessage=t}})}function d(e,t){var n=void 0,s=void 0,o=function(o){if("PONG\n"===o.data){var r=nowNs();s=r-n,e.socket.send("OK\n")}else if(0===o.data.indexOf("TIME")){var a=new RMBTPingResult;a.client=s,a.server=parseInt(o.data.substring(5)),a.timeNs=n,t(a)}};e.socket.onmessage=o,n=nowNs(),e.socket.send("PING\n")}function c(e,t){var n=e.socket.onmessage,s=0,o=0,r=-1,a=void 0,i=void 0,u=null,d=null;a=setInterval(function(){if(null!==u&&r!==o){r=o;var t=nowNs();p.debug(e.id+": "+i+"|"+b.measurementPointsTimespan+"|"+t+"|"+o);var c=new Uint8Array(u,u.byteLength-1,1),g=d-l;e.result.down.push({duration:g,bytes:s}),i=t,c[0]>=255&&(p.debug(e.id+": received end chunk"),clearInterval(a),e.socket.onmessage=function(t){p.debug(t.data),e.socket.onmessage=n},e.socket.send("OK\n"))}},b.measurementPointsTimespan);var c=function(e){o++,s+=e.data.byteLength,d=nowNs(),u=e.data};e.socket.onmessage=c;var l=nowNs();e.socket.send("GETTIME "+t+(m!==_?" "+m:"")+"\n")}function l(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=m;setTimeout(function(){var e=nowMs(),n=e-s;p.debug("diff:"+(n-t)+" ("+(n-t)/t+" %)")},t);!function i(){g(e,o,a,function(u){if(r+=o*a,p.debug(e.id+": "+u),nowMs()-s>t){e.socket.onmessage=n;var d=parseInt(u.substring(5));D.push(o*a/(d/1e9))}else{var c=2*a;o<8||!L.hasOwnProperty(c)||!I?(o*=2,i()):(a=Math.min(2*a,h),i())}})}()}function g(e,t,n,s){var o=e.socket;o.onmessage=function(e){0!==e.data.indexOf("OK")&&0!==e.data.indexOf("ACCEPT")&&s(e.data)},p.debug(e.id+": uploading "+t+" chunks, "+n*t/1e3+" KB"),o.send("PUTNORESULT"+(I?" "+n:"")+"\n");for(var r=0;r<t;r++){var a=void 0;a=r===t-1?L[n]:y[n][0],o.send(a)}}function T(e,t){var n=e.socket.onmessage,s=G/2/U,o=1.5*G/U,r=globalThis.document&&globalThis.document.hidden?o:s,a=function(){r=globalThis.document&&globalThis.document.hidden?o:s,globalThis.document&&p.debug("document visibility changed to: "+globalThis.document.hidden)};globalThis.document&&globalThis.document.addEventListener("visibilitychange",a);var i=Math.ceil(G/U/m),u=!1,d=!0,c=-1,l=0,g=function s(){u||(p.debug(e.id+": is 7.2 sec in, got data for "+c),c<1e9*t&&l<3e3?(setTimeout(s,250),l+=250):(p.debug(e.id+": didn't finish, timeout extended by "+l+" ms, last info for "+c),e.socket.onerror=function(){},e.socket.onclose=function(){},e.socket.close(),e.socket.onmessage=n,p.debug(e.id+": socket now closed: "+e.socket.readyState),e.triggerNextState()))},T=function t(){if(e.socket.bufferedAmount<r)for(var n=0;n<i;n++)e.socket.send(y[m][n%y[m].length]);if(!d)return!1;setTimeout(t,0)};setTimeout(g,1e3*t+200),setTimeout(function(){d=!1,e.socket.onclose=function(){},e.socket.send(L[m]),e.socket.send("QUIT\n")},1e3*t),p.debug(e.id+": set timeout");var f=1e6*b.measurementPointsTimespan,h=/TIME (\d+) BYTES (\d+)/,v=/TIME (\d+)/,I=function(t){"OK\n"===t.data&&T();var s=h.exec(t.data);if(null!==s){var o={duration:parseInt(s[1]),bytes:parseInt(s[2])};o.duration-c>f&&(c=o.duration,e.result.up.push(o))}else null!==(s=v.exec(t.data))&&(u=!0,p.debug("Upload duration: "+s[1]),e.socket.onmessage=n)};e.socket.onmessage=I,e.socket.send("PUT"+(m!==_?" "+m:"")+"\n")}function f(e){return{client_language:"de",client_name:b.client,client_uuid:b.uuid,client_version:b.client_version,client_software_version:b.client_software_version,geoLocations:k.geoLocations,model:b.model,network_type:98,platform:b.platform,product:b.product,pings:k.pings,test_bytes_download:k.bytes_download,test_bytes_upload:k.bytes_upload,test_nsec_download:k.nsec_download,test_nsec_upload:k.nsec_upload,test_num_threads:C,num_threads_ul:U,test_ping_shortest:k.ping_server_shortest,test_speed_download:k.speed_download,test_speed_upload:k.speed_upload,test_token:e.test_token,test_uuid:e.test_uuid,time:k.beginTime,timezone:b.timezone,type:"DESKTOP",version_code:"1",speed_detail:k.speedItems,user_server_selection:b.userServerSelection}}var p=log.getLogger("rmbtws"),m=null,h=4194304,v=0,_=4096,I=!1,b=void 0,S=void 0,k=null,N=null,E=null,M=TestState.INIT,O=null,w={durationInitMs:2500,durationPingMs:1e4,durationUpMs:-1,durationDownMs:-1},P=new RMBTIntermediateResult,R=[],y={},L={},A=null,B=0,C=0,U=0,D=[],G=0;this.onError=function(e){N=e},this.onStateChange=function(e){E=e};var x=function(e){if(p.debug("error occurred during websocket test:",e),e!==RMBTError.NOT_SUPPORTED&&n(TestState.ERROR),null!==N){var t=N;N=null,t(e)}};this.startTest=function(){if(void 0===globalThis.WebSocket)return void x(RMBTError.NOT_SUPPORTED);n(TestState.INIT),k=new RMBTTestResult,S.getDataCollectorInfo(),S.obtainControlServerRegistration(function(e){B=parseInt(e.test_numthreads),A=new CyclicBarrier(B),w.durationDownMs=1e3*e.test_duration,w.durationUpMs=1e3*e.test_duration,null!==TestEnvironment.getTestVisualization()&&TestEnvironment.getTestVisualization().updateInfo(e.test_server_name,e.client_remote_ip,e.provider,e.test_uuid,e.open_test_uuid);var t=function(){p.debug("got geolocation, obtaining token and websocket address");var t=function(){n(TestState.INIT),k.beginTime=Date.now();for(var t=0;t<B;t++){var r=new RMBTTestThread(A);r.id=t,k.addThread(r.result),s(e,r,function(){p.info("All tests finished"),o.stop(),TestEnvironment.getTestVisualization().getGeoResults?k.geoLocations=TestEnvironment.getTestVisualization().getGeoResults():k.geoLocations=o.getResults(),k.calculateAll(),S.submitResults(f(e),function(){n(TestState.END)},function(){x(RMBTError.SUBMIT_FAILED)})}),R.push(r)}};0===e.test_wait?t():(p.info("test scheduled for start in "+e.test_wait+" second(s)"),n(TestState.WAIT),self.setTimeout(function(){t()},1e3*e.test_wait))},o=void 0;null!==TestEnvironment.getGeoTracker()?(o=TestEnvironment.getGeoTracker(),t()):(o=new GeoTracker,p.debug("getting geolocation"),o.start(function(){t()},TestEnvironment.getTestVisualization()))},function(){x(RMBTError.REGISTRATION_FAILED)})},this.getIntermediateResult=function(){P.status=M;var e=nowNs()/1e6-O;switch(P.status){case TestState.WAIT:P.progress=0;break;case TestState.INIT:case TestState.INIT_DOWN:case TestState.INIT_UP:P.progress=e/w.durationInitMs;break;case TestState.PING:P.progress=e/w.durationPingMs;break;case TestState.DOWN:P.progress=e/w.durationDownMs;break;case TestState.UP:P.progress=e/w.durationUpMs;break;case TestState.END:P.progress=1;break;case TestState.ERROR:case TestState.ABORTED:P.progress=0}if(isNaN(P.progress)&&(P.progress=0),P.progress=Math.min(1,P.progress),null!==k){if(P.status!==TestState.PING&&P.status!==TestState.DOWN||(P.pingNano=k.ping_server_median,P.pings=k.pings),P.status===TestState.DOWN||P.status==TestState.INIT_UP){var t=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(k.threads,function(e){return e.down});P.downBitPerSec=t.speed,P.downBitPerSecLog=(Math.log10(P.downBitPerSec/1e6)+2)/4}if(P.status===TestState.UP||P.status==TestState.INIT_UP){var n=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(k.threads,function(e){return e.up});P.upBitPerSec=n.speed,P.upBitPerSecLog=(Math.log10(P.upBitPerSec/1e6)+2)/4}}return P},this.getState=function(){return"INIT"},function(e,t){b=e,S=t}(e,t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.RMBTTest=RMBTTest;
"use strict";function runCallback(){void 0!=geo_callback&&"function"==typeof geo_callback&&setTimeout(function(){geo_callback()},1)}function getCurLocation(){return curGeoPos}function getLocation(o,e,t,n){var a=globalThis.document&&globalThis.document.getElementById("infogeo");if(geo_callback=n,!navigator.geolocation){var i=getCookie("coords");if(i){var r=JSON.parse(i);r&&r.lat>0&&r.long>0&&testVisualization.setLocation(r.lat,r.long)}else a&&(a.innerHTML=Lang.getString("NotSupported"));return void runCallback()}runCallback(),TestEnvironment.getGeoTracker().start(function(o,e){if(!0!==o&&a)if(e)switch(e.code){case e.PERMISSION_DENIED:a.innerHTML=Lang.getString("NoPermission");break;case e.TIMEOUT:break;case e.POSITION_UNAVAILABLE:a.innerHTML=Lang.getString("NotAvailable");break;case e.UNKNOWN_ERROR:a.innerHTML=Lang.getString("NotAvailable")+"("+e.code+")"}else a.innerHTML=Lang.getString("NotAvailable")},TestEnvironment.getTestVisualization())}Object.defineProperty(exports,"__esModule",{value:!0});var curGeoPos=void 0,geo_callback=void 0,loc_timeout=void 0,GeoTracker=exports.GeoTracker=function(){function o(){e=[],i=!1}var e=void 0,t=void 0,n=null,a=void 0,i=void 0;o.prototype.start=function(o,l){if(t=o,void 0!==l&&(n=l),navigator.geolocation)navigator.geolocation.getCurrentPosition(function(o){0===e.length&&(i=!0,r(o))},c,{enableHighAccuracy:!1,timeout:2e3,maximumAge:6e4}),a=navigator.geolocation.watchPosition(r,c,{enableHighAccuracy:!0,timeout:1/0,maximumAge:0});else{var u=t;t=null,u(!1)}setTimeout(function(){c()},2e3)};var r=function(o){if(1===e.length&&i&&(e=[],i=!1),e.push({geo_lat:o.coords.latitude,geo_long:o.coords.longitude,accuracy:o.coords.accuracy,altitude:o.coords.altitude,bearing:o.coords.heading,speed:o.coords.speed,tstamp:o.timestamp,provider:"Browser"}),null!==t){var a=t;t=null,a(!0)}null!==n&&n.setLocation(o.coords.latitude,o.coords.longitude),l(o)},c=function(o){if(null!==t){var e=t;t=null,e(!1,o)}},l=function(o){var e={};e.lat=o.coords.latitude,e.long=o.coords.longitude,e.accuracy=o.coords.accuracy,e.altitude=o.coords.altitude,e.heading=o.coords.heading,e.speed=o.coords.speed,e.tstamp=o.timestamp,e=JSON.stringify(e),setCookie("coords",e,3600)};return o.prototype.stop=function(){navigator.geolocation&&navigator.geolocation.clearWatch(a)},o.prototype.getResults=function(){var o=null;return e=e.filter(function(e){return null==o?(o=e,!0):!Object.keys(e).every(function(t){return o.hasOwnProperty(t)&&o[t]===e[t]})&&(o=e,!0)})},o}();
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var RMBTControlServerCommunication=exports.RMBTControlServerCommunication=function(e,r){var t=e,n=log.getLogger("rmbtws");r=r||{};var o=r.register||null,i=r.submit||null,s=r.headers||{"Content-Type":"application/json"};return{obtainControlServerRegistration:function(e,r){var i={version:t.version,language:t.language,uuid:t.uuid,type:t.type,version_code:t.version_code,client:t.client,timezone:t.timezone,time:(new Date).getTime()};Object.assign(i,t.additionalRegistrationParameters),"undefined"!=typeof userServerSelection&&userServerSelection>0&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(i.prefer_server=UserConf.preferredServer,i.user_server_selection=userServerSelection);var u=void 0;fetch(t.controlServerURL+t.controlServerRegistrationResource,{method:"POST",headers:s,body:JSON.stringify(i)}).then(function(e){return e.json()}).then(function(r){u=r;var t=new RMBTControlServerRegistrationResponse(r);e(t)}).catch(function(e){u=e,n.error("error getting testID"),r()}).finally(function(){null!=o&&"function"==typeof o&&o({response:u,request:i})})},getDataCollectorInfo:function(){fetch(t.controlServerURL+t.controlServerDataCollectorResource,{method:"GET",headers:s}).then(function(e){return e.json()}).then(function(e){t.product=e.agent.substring(0,Math.min(150,e.agent.length)),t.model=e.product,t.os_version=e.version}).catch(function(){n.error("error getting data collection response")})},submitResults:function(e,r,o){Object.assign(e,t.additionalSubmissionParameters);var u=JSON.stringify(e);n.debug("Submit size: "+u.length);var c=void 0;fetch(t.controlServerURL+t.controlServerResultResource,{method:"POST",headers:s,body:u}).then(function(e){return e.json()}).then(function(t){c=t,n.debug(e.test_uuid),r(!0)}).catch(function(e){c=e,n.error("error submitting results"),o(!1)}).finally(function(){null!==i&&"function"==typeof i&&i({response:c,request:e})})}}};
...
"use strict";function _classCallCheck(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function nowMs(){return performance.now()}function nowNs(){return Math.round(1e6*performance.now())}function CyclicBarrier(n){var e=n,t=[],o=function(){var n=t.slice();t=[],self.setTimeout(function(){for(var t=0;t<e;t++)n[t]()},1)};return{await:function(n){t.push(n),t.length===e&&o()}}}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function n(n,e){for(var t=0;t<e.length;t++){var o=e[t];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(n,o.key,o)}}return function(e,t,o){return t&&n(e.prototype,t),o&&n(e,o),e}}();!function(){if(Date.now||(Date.now=function(){return(new Date).getTime()}),"undefined"==typeof performance&&(performance={}),!performance.now||void 0===performance.now){var n=Date.now();performance.timing&&performance.timing.navigationStart&&(n=performance.timing.navigationStart),performance.now=function(){return Date.now()-n}}}(),Math.median=function(n){n.sort(function(n,e){return n-e});var e=Math.floor(n.length/2);return n.length%2?n[e]:(n[e-1]+n[e])/2},Math.log10=Math.log10||function(n){return Math.log(n)/Math.LN10};var Log=function(){function n(){_classCallCheck(this,n)}return _createClass(n,[{key:"debug",value:function(){var n;(n=console).log.apply(n,arguments)}},{key:"trace",value:function(){console.trace()}},{key:"info",value:function(){var n;(n=console).info.apply(n,arguments)}},{key:"warn",value:function(){var n;(n=console).warn.apply(n,arguments)}},{key:"error",value:function(){var n;(n=console).error.apply(n,arguments)}},{key:"disable",value:function(){this.debug=function(){},this.trace=function(){},this.info=function(){},this.warn=function(){}}},{key:"setLevel",value:function(){}},{key:"getLogger",value:function(){return this}}]),n}();self.log=self.log||new Log;var log=exports.log=self.log;"function"!=typeof Object.assign&&(Object.assign=function(n,e){if(null==n)throw new TypeError("Cannot convert undefined or null to object");for(var t=Object(n),o=1;o<arguments.length;o++){var r=arguments[o];if(null!=r)for(var a in r)Object.prototype.hasOwnProperty.call(r,a)&&(t[a]=r[a])}return t});
