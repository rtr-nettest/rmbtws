 ...
 *****************************************************************************!*/
function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,t){var n;if(e)return"string"==typeof e?_arrayLikeToArray(e,t):"Map"===(n="Object"===(n={}.toString.call(e).slice(8,-1))&&e.constructor?e.constructor.name:n)||"Set"===n?Array.from(e):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(e,t):void 0}function _iterableToArray(e){if("undefined"!=typeof Symbol&&null!=e[Symbol.iterator]||null!=e["@@iterator"])return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e))return _arrayLikeToArray(e)}function _arrayLikeToArray(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,s=Array(t);n<t;n++)s[n]=e[n];return s}function RMBTTest(e,t){var I,o,S=log.getLogger("rmbtws"),k=null,p=4194304,m=0,v=4096,N=!1,c=null,n=null,s=null,r=TestState.INIT,a=null,l={durationInitMs:2500,durationPingMs:1e4,durationUpMs:-1,durationDownMs:-1},i=new RMBTIntermediateResult,u=[],E={},M={},d=null,g=0,T=0,y=0,w=[],O=0;function P(e){void 0!==r&&r===e||(r=e,a=nowMs(),s&&s(e))}this.onError=function(e){n=e},this.onStateChange=function(e){s=e};var f=function(e){var t;S.debug("error occurred during websocket test:",e),e!==RMBTError.NOT_SUPPORTED&&P(TestState.ERROR),null!==n&&(t=n,n=null,t(e))};function R(n,e,s,o){try{n.socket=new WebSocket(e)}catch(e){return void f(RMBTError.SOCKET_INIT_FAILED)}n.socket.binaryType="arraybuffer",n.socket.onerror=o,n.socket.onclose=o,n.socket.onmessage=function(e){var t;0===e.data.indexOf("CHUNKSIZE")?(4===(t=e.data.trim().split(" ")).length?(v=parseInt(t[1]),m=parseInt(t[2]),p=parseInt(t[3])):(v=parseInt(t[1]),m=v),S.debug(n.id+": Chunksizes: min "+m+", max: "+p+", default: "+v)):0===e.data.indexOf("RMBTv")?(t=e.data.substring(5).trim(),0===(I.client_version=t).indexOf("1.")?N=!0:0===t.indexOf("0.3")?N=!1:S.warn("unknown server version: "+t)):"ACCEPT TOKEN QUIT\n"===e.data?n.socket.send("TOKEN "+s+"\n"):"OK\n"===e.data&&n.state===TestState.INIT?S.debug(n.id+": Token accepted"):"ERR\n"===e.data?(o(),S.error("got error msg")):0===e.data.indexOf("ACCEPT GETCHUNKS")&&n.triggerNextState()}}function A(e,t,n){O=e.reduce(function(e,t){return e+t}),S.debug("total: circa "+O/1e3+" KB/sec"),S.debug("total: circa "+8*O/1e6+" MBit/sec");var s,o=8*O/1e6,r=0,a=(Object.keys(t).forEach(function(e){e<o&&(r=t[e])}),r=Math.min(g,r),S.debug("set number of threads to be used in upcoming speed test to: "+r),O/(1e3/(I.measurementPointsTimespan/2)));return a-=a%1024,a=Math.max(m,a),a=Math.min(p,a),S.debug("calculated chunksize for upcoming speed test "+a/1024+" KB"),n&&(s=Number.POSITIVE_INFINITY,Object.keys(E).forEach(function(e){Math.abs(a-e)<Math.abs(a-s)?("string"==typeof e&&(e=parseInt(e)),s=e):(delete E[e],delete M[e])}),a=s,S.debug("fallback to existing chunksize for upcoming speed test "+a/1024+" KB")),{numThreads:r,chunkSize:a,bytesPerSecs:O}}function L(n,s){var o,r;n.socket.onmessage=function(e){var t;"PONG\n"===e.data?(t=nowNs(),r=t-o,n.socket.send("OK\n")):0===e.data.indexOf("TIME")&&((t=new RMBTPingResult).client=r,t.server=parseInt(e.data.substring(5)),t.timeNs=o,s(t))},o=nowNs(),n.socket.send("PING\n")}this.startTest=function(){void 0===globalThis.WebSocket?f(RMBTError.NOT_SUPPORTED):(P(TestState.INIT),c=new RMBTTestResult,o.getDataCollectorInfo(),o.obtainControlServerRegistration(function(n){g=parseInt(n.test_numthreads),d=new CyclicBarrier(g),l.durationDownMs=1e3*n.test_duration,l.durationUpMs=1e3*n.test_duration,null!==TestEnvironment.getTestVisualization()&&TestEnvironment.getTestVisualization().updateInfo(n.test_server_name,n.client_remote_ip,n.provider,n.test_uuid,n.open_test_uuid);function e(){function e(){P(TestState.INIT),c.beginTime=Date.now();for(var e=0;e<g;e++){var t=new RMBTTestThread(d);t.id=e,c.addThread(t.result),((_,h,e)=>{var t=(_.test_server_encryption?"wss://":"ws://")+_.test_server_address+":"+_.test_server_port,b=(S.debug(t),{IGNORE:function(){},CALLGLOBALHANDLER:function(e){e&&S.error("connection closed",e),f(RMBTError.CONNECT_FAILED)},TRYRECONNECT:function(){f(RMBTError.CONNECT_FAILED)}});h.onStateEnter(TestState.INIT_DOWN,function(){function s(){var e,t,r,a,i,n,u;t=g,r=T,a=function(e){S.debug(o.id+": "+e);var e=parseInt(e.substring(5)),t=nowMs();d<t-l?(w.push(g*T/(e/1e9)),o.socket.onmessage=c):(g<8||!N?g*=2:T=Math.min(2*T,p),s())},i=(e=o).socket,n=k*t,u=null,i.onmessage=function(e){var t,n,s,o;"string"!=typeof e.data&&(t=!1,u=null===u?new Uint8Array(e.data):(n=u,s=new Uint8Array(e.data),(o=new Uint8Array(n.length+s.length)).set(n,0),o.set(s,n.length),o),e.data.byteLength,u.length===r&&(t=!0),t&&255===u[u.length-1]?(i.onmessage=function(e){e=e.data;a(e)},i.send("OK\n"),M[r]=u.buffer,u=null):(E.hasOwnProperty(r)||(E[r]=[]),t&&(E[r].length<I.savedChunks&&E[r].push(u.buffer),u=null)))},S.debug(e.id+": downloading "+t+" chunks, "+n/1e3+" KB"),e="GETCHUNKS "+t+(r!==v?" "+r:"")+"\n",i.send(e)}var o,d,c,l,g,T;P(TestState.INIT_DOWN),S.debug(h.id+": start short download"),k=m,o=h,d=I.pretestDurationMs,c=o.socket.onmessage,l=nowMs(),g=1,T=k,s()}),h.onStateEnter(TestState.PING,function(){function r(e){if(a.result.pings.push(e),c.pings=_toConsumableArray(a.result.pings),u===I.numPings-1&&(l.durationPingMs=(a.result.pings[1].timeNs-a.result.pings[0].timeNs)/1e6*I.numPings,S.debug(a.id+": PING phase will take approx "+l.durationPingMs+" ms")),S.debug(a.id+": PING "+e.client+" ns client; "+e.server+" ns server"),u--,0<(u=0<I.doPingIntervalMilliseconds&&0===u&&performance.now()-d<I.doPingIntervalMilliseconds?1:u))a.socket.onmessage=function(e){"ACCEPT GETCHUNKS GETTIME PUT PUTNORESULT PING QUIT\n"===e.data?L(a,r):S.error("unexpected error during ping test")};else{for(var t=[],n=0;n<a.result.pings.length;n++)t.push(a.result.pings[n].client);c.ping_client_median=Math.median(t),c.ping_client_shortest=Math.min.apply(Math,t);for(var s=[],o=0;o<a.result.pings.length;o++)s.push(a.result.pings[o].server);c.ping_server_median=Math.median(s),c.ping_server_shortest=Math.min.apply(Math,s),S.debug(a.id+": median client: "+Math.round(c.ping_client_median/1e3)/1e3+" ms; median server: "+Math.round(c.ping_server_median/1e3)/1e3+" ms"),S.debug(a.id+": shortest client: "+Math.round(c.ping_client_shortest/1e3)/1e3+" ms; shortest server: "+Math.round(c.ping_server_shortest/1e3)/1e3+" ms"),a.socket.onmessage=i}}var a,i,u,d;P(TestState.PING),S.debug(h.id+": starting ping"),0===h.id?(i=(a=h).socket.onmessage,u=I.numPings,d=performance.now(),L(a,r)):h.triggerNextState()}),h.onStateEnter(TestState.DOWN,function(){var s,e,o,r,a,i,u,d,c,l,g;P(TestState.DOWN),0<w.length&&(e=A(w,I.downloadThreadsLimitsMbit,!1),T=e.numThreads,N&&(k=e.chunkSize),w=[]),h.id<T?(s=h,e=_.test_duration,a=s.socket.onmessage,u=i=0,d=-1,l=c=null,o=setInterval(function(){var e,t,n;null!==c&&d!==u&&(d=u,e=nowNs(),S.debug(s.id+": "+r+"|"+I.measurementPointsTimespan+"|"+e+"|"+u),t=new Uint8Array(c,c.byteLength-1,1),n=l-g,s.result.down.push({duration:n,bytes:i}),r=e,255<=t[0])&&(S.debug(s.id+": received end chunk"),clearInterval(o),s.socket.onmessage=function(e){S.debug(e.data),s.socket.onmessage=a},s.socket.send("OK\n"))},I.measurementPointsTimespan),s.socket.onmessage=function(e){u++,i+=e.data.byteLength,l=nowNs(),c=e.data},g=nowNs(),s.socket.send("GETTIME "+e+(k!==v?" "+k:"")+"\n")):(h.socket.onerror=b.IGNORE,h.socket.onclose=b.IGNORE,h.triggerNextState())}),h.onStateEnter(TestState.CONNECT_UPLOAD,function(){P(TestState.INIT_UP),h.socket.onerror=b.IGNORE,h.socket.onclose=b.IGNORE,h.socket.close(),R(h,t,_.test_token,b.CALLGLOBALHANDLER)}),h.onStateEnter(TestState.INIT_UP,function(){k=m;var i=h,u=I.pretestDurationMs;function d(){var e=i,t=g,n=T,s=function(e){S.debug(i.id+": "+e);var t=nowMs();u<t-l?(i.socket.onmessage=c,t=parseInt(e.substring(5)),w.push(g*T/(t/1e9))):(e=2*T,g<8||!M.hasOwnProperty(e)||!N?g*=2:T=Math.min(2*T,p),d())},o=e.socket;o.onmessage=function(e){0!==e.data.indexOf("OK")&&0!==e.data.indexOf("ACCEPT")&&s(e.data)},S.debug(e.id+": uploading "+t+" chunks, "+n*t/1e3+" KB"),o.send("PUTNORESULT"+(N?" "+n:"")+"\n");for(var r=0;r<t;r++){var a=void 0;a=r===t-1?M[n]:E[n][0],o.send(a)}}var c=i.socket.onmessage,l=nowMs(),g=1,T=k;setTimeout(function(){var e=nowMs()-l;S.debug("diff:"+(e-u)+" ("+(e-u)/u+" %)")},u),d()}),h.onStateEnter(TestState.UP,function(){var e,s,t,o,n,r,a,i,u,d,c,l,g,T,p,m;function f(){u||(S.debug(s.id+": is 7.2 sec in, got data for "+c),c<1e9*t&&l<3e3?(setTimeout(f,250),l+=250):(S.debug(s.id+": didn't finish, timeout extended by "+l+" ms, last info for "+c),s.socket.onerror=function(){},s.socket.onclose=function(){},s.socket.close(),s.socket.onmessage=o,S.debug(s.id+": socket now closed: "+s.socket.readyState),s.triggerNextState()))}P(TestState.UP),0<w.length&&(e=A(w,I.uploadThreadsLimitsMbit,!0),y=e.numThreads,N&&(k=e.chunkSize),w=[]),h.id<y?(s=h,t=_.test_duration,o=s.socket.onmessage,n=O/2/y,r=1.5*O/y,a=globalThis.document&&globalThis.document.hidden?r:n,globalThis.document&&globalThis.document.addEventListener("visibilitychange",function(){a=globalThis.document&&globalThis.document.hidden?r:n,globalThis.document&&S.debug("document visibility changed to: "+globalThis.document.hidden)}),i=Math.ceil(O/y/k),d=!(u=!1),c=-1,l=0,g=function(){if(s.socket.bufferedAmount<a)for(var e=0;e<i;e++)s.socket.send(E[k][e%E[k].length]);if(!d)return!1;setTimeout(g,0)},setTimeout(f,1e3*t+200),setTimeout(function(){d=!1,s.socket.onclose=function(){},s.socket.send(M[k]),s.socket.send("QUIT\n")},1e3*t),S.debug(s.id+": set timeout"),T=1e6*I.measurementPointsTimespan,p=/TIME (\d+) BYTES (\d+)/,m=/TIME (\d+)/,s.socket.onmessage=function(e){"OK\n"===e.data&&g();var t,n=p.exec(e.data);null!==n?(t={duration:parseInt(n[1]),bytes:parseInt(n[2])},T<t.duration-c&&(c=t.duration,s.result.up.push(t))):null!==(n=m.exec(e.data))&&(u=!0,S.debug("Upload duration: "+n[1]),s.socket.onmessage=o)},s.socket.send("PUT"+(k!==v?" "+k:"")+"\n")):(h.socket.onerror=b.IGNORE,h.socket.onclose=b.IGNORE,h.socket.readyState!==WebSocket.CLOSED&&h.socket.close(),h.triggerNextState())}),h.onStateEnter(TestState.END,function(){h.socket.readyState!==WebSocket.CLOSED&&h.socket.close(),0===h.id&&e()}),h.setState(TestState.INIT),P(TestState.INIT),R(h,t,_.test_token,b.CALLGLOBALHANDLER)})(n,t,function(){S.info("All tests finished"),s.stop(),TestEnvironment.getTestVisualization().getGeoResults?c.geoLocations=TestEnvironment.getTestVisualization().getGeoResults():c.geoLocations=s.getResults(),c.calculateAll(),o.submitResults({client_language:"de",client_name:I.client,client_uuid:I.uuid,client_version:I.client_version,client_software_version:I.client_software_version,geoLocations:c.geoLocations,model:I.model,network_type:98,platform:I.platform,product:I.product,pings:c.pings,test_bytes_download:c.bytes_download,test_bytes_upload:c.bytes_upload,test_nsec_download:c.nsec_download,test_nsec_upload:c.nsec_upload,test_num_threads:T,num_threads_ul:y,test_ping_shortest:c.ping_server_shortest,test_speed_download:c.speed_download,test_speed_upload:c.speed_upload,test_token:n.test_token,test_uuid:n.test_uuid,time:c.beginTime,timezone:I.timezone,type:"DESKTOP",version_code:"1",speed_detail:c.speedItems,user_server_selection:I.userServerSelection},function(){P(TestState.END)},function(){f(RMBTError.SUBMIT_FAILED)})}),u.push(t)}}S.debug("got geolocation, obtaining token and websocket address"),0===n.test_wait?e():(S.info("test scheduled for start in "+n.test_wait+" second(s)"),P(TestState.WAIT),self.setTimeout(function(){e()},1e3*n.test_wait))}var s;null!==TestEnvironment.getGeoTracker()?(s=TestEnvironment.getGeoTracker(),e()):(s=new GeoTracker,S.debug("getting geolocation"),s.start(function(){e()},TestEnvironment.getTestVisualization()))},function(){f(RMBTError.REGISTRATION_FAILED)}))},this.getIntermediateResult=function(){i.status=r;var e,t=nowNs()/1e6-a;switch(i.status){case TestState.WAIT:i.progress=0;break;case TestState.INIT:case TestState.INIT_DOWN:case TestState.INIT_UP:i.progress=t/l.durationInitMs;break;case TestState.PING:i.progress=t/l.durationPingMs;break;case TestState.DOWN:i.progress=t/l.durationDownMs;break;case TestState.UP:i.progress=t/l.durationUpMs;break;case TestState.END:i.progress=1;break;case TestState.ERROR:case TestState.ABORTED:i.progress=0}return isNaN(i.progress)&&(i.progress=0),i.progress=Math.min(1,i.progress),null!==c&&(i.status!==TestState.PING&&i.status!==TestState.DOWN||(i.pingNano=c.ping_server_median,i.pings=c.pings),i.status!==TestState.DOWN&&i.status!=TestState.INIT_UP||(e=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(c.threads,function(e){return e.down}),i.downBitPerSec=e.speed,i.downBitPerSecLog=(Math.log10(i.downBitPerSec/1e6)+2)/4),i.status!==TestState.UP&&i.status!=TestState.INIT_UP||(e=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(c.threads,function(e){return e.up}),i.upBitPerSec=e.speed,i.upBitPerSecLog=(Math.log10(i.upBitPerSec/1e6)+2)/4)),i},this.getState=function(){return"INIT"},I=e,o=t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.RMBTTest=RMBTTest;
var curGeoPos,geo_callback,loc_timeout;function runCallback(){null!=geo_callback&&"function"==typeof geo_callback&&setTimeout(function(){geo_callback()},1)}function getCurLocation(){return curGeoPos}function getLocation(o,e,t,n){var a=globalThis.document&&globalThis.document.getElementById("infogeo");geo_callback=n,navigator.geolocation?(runCallback(),TestEnvironment.getGeoTracker().start(function(o,e){if(!0!==o&&a)if(e)switch(e.code){case e.PERMISSION_DENIED:a.innerHTML=Lang.getString("NoPermission");break;case e.TIMEOUT:break;case e.POSITION_UNAVAILABLE:a.innerHTML=Lang.getString("NotAvailable");break;case e.UNKNOWN_ERROR:a.innerHTML=Lang.getString("NotAvailable")+"("+e.code+")"}else a.innerHTML=Lang.getString("NotAvailable")},TestEnvironment.getTestVisualization())):((n=getCookie("coords"))?(n=JSON.parse(n))&&0<n.lat&&0<n.long&&testVisualization.setLocation(n.lat,n.long):a&&(a.innerHTML=Lang.getString("NotSupported")),runCallback())}Object.defineProperty(exports,"__esModule",{value:!0}),exports.GeoTracker=void 0;var GeoTracker=exports.GeoTracker=(()=>{var n,t,a,r,i=null;function o(){r=!(n=[])}o.prototype.start=function(o,e){t=o,void 0!==e&&(i=e),navigator.geolocation?(navigator.geolocation.getCurrentPosition(function(o){0===n.length&&(r=!0,c(o))},l,{enableHighAccuracy:!1,timeout:2e3,maximumAge:6e4}),a=navigator.geolocation.watchPosition(c,l,{enableHighAccuracy:!0,timeout:1/0,maximumAge:0})):(o=t,t=null,o(!1)),setTimeout(function(){l()},2e3)};var c=function(o){1===n.length&&(r=r&&!(n=[])),n.push({geo_lat:o.coords.latitude,geo_long:o.coords.longitude,accuracy:o.coords.accuracy,altitude:o.coords.altitude,bearing:o.coords.heading,speed:o.coords.speed,tstamp:o.timestamp,provider:"Browser"}),null!==t&&t(!(t=null)),null!==i&&i.setLocation(o.coords.latitude,o.coords.longitude),e(o)},l=function(o){var e;null!==t&&(e=t,t=null,e(!1,o))},e=function(o){var e={};e.lat=o.coords.latitude,e.long=o.coords.longitude,e.accuracy=o.coords.accuracy,e.altitude=o.coords.altitude,e.heading=o.coords.heading,e.speed=o.coords.speed,e.tstamp=o.timestamp,e=JSON.stringify(e),setCookie("coords",e,3600)};return o.prototype.stop=function(){navigator.geolocation&&navigator.geolocation.clearWatch(a)},o.prototype.getResults=function(){var t=null;return n=n.filter(function(e){return!(null!=t&&Object.keys(e).every(function(o){return t.hasOwnProperty(o)&&t[o]===e[o]})||(t=e,0))})},o})();
