 ...
 *****************************************************************************!*/
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function RMBTTest(e,t){function n(e){void 0!==M&&M===e||(M=e,w=nowMs(),E&&E(e))}function s(e,t,s){var i=(e.test_server_encryption?"wss://":"ws://")+e.test_server_address+":"+e.test_server_port;p.debug(i);var d=function(){return{IGNORE:function(){},CALLGLOBALHANDLER:function(e){e&&p.error("connection closed",e),x(RMBTError.CONNECT_FAILED)},TRYRECONNECT:function(){x(RMBTError.CONNECT_FAILED)}}}();t.onStateEnter(TestState.INIT_DOWN,function(){n(TestState.INIT_DOWN),p.debug(t.id+": start short download"),m=v,a(t,S.pretestDurationMs)}),t.onStateEnter(TestState.PING,function(){n(TestState.PING),p.debug(t.id+": starting ping"),0===t.id?u(t):t.triggerNextState()}),t.onStateEnter(TestState.DOWN,function(){if(n(TestState.DOWN),D.length>0){var s=r(D,S.downloadThreadsLimitsMbit,!1);C=s.numThreads,I&&(m=s.chunkSize),D=[]}t.id<C?c(t,e.test_duration):(t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.triggerNextState())}),t.onStateEnter(TestState.CONNECT_UPLOAD,function(){n(TestState.INIT_UP),t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.socket.close(),o(t,i,e.test_token,d.CALLGLOBALHANDLER)}),t.onStateEnter(TestState.INIT_UP,function(){m=v,l(t,S.pretestDurationMs)}),t.onStateEnter(TestState.UP,function(){if(n(TestState.UP),D.length>0){var s=r(D,S.uploadThreadsLimitsMbit,!0);U=s.numThreads,I&&(m=s.chunkSize),D=[]}t.id<U?T(t,e.test_duration):(t.socket.onerror=d.IGNORE,t.socket.onclose=d.IGNORE,t.socket.readyState!==WebSocket.CLOSED&&t.socket.close(),t.triggerNextState())}),t.onStateEnter(TestState.END,function(){t.socket.readyState!==WebSocket.CLOSED&&t.socket.close(),0===t.id&&s()}),t.setState(TestState.INIT),n(TestState.INIT),o(t,i,e.test_token,d.CALLGLOBALHANDLER)}function o(e,t,n,s){try{e.socket=new WebSocket(t)}catch(e){return void x(RMBTError.SOCKET_INIT_FAILED)}e.socket.binaryType="arraybuffer",e.socket.onerror=s,e.socket.onclose=s,e.socket.onmessage=function(t){if(0===t.data.indexOf("CHUNKSIZE")){var o=t.data.trim().split(" ");4===o.length?(h=parseInt(o[1]),v=parseInt(o[2]),_=parseInt(o[3])):(h=parseInt(o[1]),v=h),p.debug(e.id+": Chunksizes: min "+v+", max: "+_+", default: "+h)}else if(0===t.data.indexOf("RMBTv")){var r=t.data.substring(5).trim();S.client_version=r,0===r.indexOf("1.")?I=!0:0===r.indexOf("0.3")?I=!1:p.warn("unknown server version: "+r)}else"ACCEPT TOKEN QUIT\n"===t.data?e.socket.send("TOKEN "+n+"\n"):"OK\n"===t.data&&e.state===TestState.INIT?p.debug(e.id+": Token accepted"):"ERR\n"===t.data?(s(),p.error("got error msg")):0===t.data.indexOf("ACCEPT GETCHUNKS")&&e.triggerNextState()}}function r(e,t,n){G=e.reduce(function(e,t){return e+t}),p.debug("total: circa "+G/1e3+" KB/sec"),p.debug("total: circa "+8*G/1e6+" MBit/sec");var s=8*G/1e6,o=0;Object.keys(t).forEach(function(e){s>e&&(o=t[e])}),o=Math.min(B,o),p.debug("set number of threads to be used in upcoming speed test to: "+o);var r=G/(1e3/(S.measurementPointsTimespan/2));if(r-=r%1024,r=Math.max(v,r),r=Math.min(_,r),p.debug("calculated chunksize for upcoming speed test "+r/1024+" KB"),n){var a=Number.POSITIVE_INFINITY;Object.keys(y).forEach(function(e){Math.abs(r-e)<Math.abs(r-a)?("string"==typeof e&&(e=parseInt(e)),a=e):(delete y[e],delete A[e])}),r=a,p.debug("fallback to existing chunksize for upcoming speed test "+r/1024+" KB")}return{numThreads:o,chunkSize:r,bytesPerSecs:G}}function a(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=m;!function u(){i(e,o,a,function(i){r+=o*a,p.debug(e.id+": "+i);var d=parseInt(i.substring(5));nowMs()-s>t?(D.push(o*a/(d/1e9)),e.socket.onmessage=n):o<8||!I?(o*=2,u()):(a=Math.min(2*a,_),u())})}()}function i(e,t,n,s){var o=e.socket,r=t,a=m*t,i=0,u=null,d=function(e,t){var n=new Uint8Array(e.length+t.length);return n.set(e,0),n.set(t,e.length),n},c=function(e){if("string"!=typeof e.data){var t=!1;u=null===u?new Uint8Array(e.data):d(u,new Uint8Array(e.data)),i+=e.data.byteLength,u.length===n&&(r--,t=!0),t&&255===u[u.length-1]?(o.onmessage=function(e){var t=e.data;s(t)},o.send("OK\n"),A[n]=u.buffer,u=null):(y.hasOwnProperty(n)||(y[n]=[]),t&&(y[n].length<S.savedChunks&&y[n].push(u.buffer),u=null))}};o.onmessage=c,p.debug(e.id+": downloading "+t+" chunks, "+a/1e3+" KB");var l="GETCHUNKS "+t+(n!==h?" "+n:"")+"\n";o.send(l)}function u(e){var t=e.socket.onmessage,n=S.numPings,s=performance.now();d(e,function o(r){if(e.result.pings.push(r),N.pings=[].concat(_toConsumableArray(e.result.pings)),n===S.numPings-1&&(O.durationPingMs=(e.result.pings[1].timeNs-e.result.pings[0].timeNs)/1e6*S.numPings,p.debug(e.id+": PING phase will take approx "+O.durationPingMs+" ms")),p.debug(e.id+": PING "+r.client+" ns client; "+r.server+" ns server"),n--,S.doPingIntervalMilliseconds>0&&0===n){performance.now()-s<S.doPingIntervalMilliseconds&&(n=1)}if(n>0)e.socket.onmessage=function(t){"ACCEPT GETCHUNKS GETTIME PUT PUTNORESULT PING QUIT\n"===t.data?d(e,o):p.error("unexpected error during ping test")};else{for(var a=[],i=0;i<e.result.pings.length;i++)a.push(e.result.pings[i].client);N.ping_client_median=Math.median(a),N.ping_client_shortest=Math.min.apply(Math,a);for(var u=[],c=0;c<e.result.pings.length;c++)u.push(e.result.pings[c].server);N.ping_server_median=Math.median(u),N.ping_server_shortest=Math.min.apply(Math,u),p.debug(e.id+": median client: "+Math.round(N.ping_client_median/1e3)/1e3+" ms; median server: "+Math.round(N.ping_server_median/1e3)/1e3+" ms"),p.debug(e.id+": shortest client: "+Math.round(N.ping_client_shortest/1e3)/1e3+" ms; shortest server: "+Math.round(N.ping_server_shortest/1e3)/1e3+" ms"),e.socket.onmessage=t}})}function d(e,t){var n=void 0,s=void 0,o=function(o){if("PONG\n"===o.data){var r=nowNs();s=r-n,e.socket.send("OK\n")}else if(0===o.data.indexOf("TIME")){var a=new RMBTPingResult;a.client=s,a.server=parseInt(o.data.substring(5)),a.timeNs=n,t(a)}};e.socket.onmessage=o,n=nowNs(),e.socket.send("PING\n")}function c(e,t){var n=e.socket.onmessage,s=0,o=0,r=-1,a=void 0,i=void 0,u=null,d=null;a=setInterval(function(){if(null!==u&&r!==o){r=o;var t=nowNs();p.debug(e.id+": "+i+"|"+S.measurementPointsTimespan+"|"+t+"|"+o);var c=new Uint8Array(u,u.byteLength-1,1),g=d-l;e.result.down.push({duration:g,bytes:s}),i=t,c[0]>=255&&(p.debug(e.id+": received end chunk"),clearInterval(a),e.socket.onmessage=function(t){p.debug(t.data),e.socket.onmessage=n},e.socket.send("OK\n"))}},S.measurementPointsTimespan);var c=function(e){o++,s+=e.data.byteLength,d=nowNs(),u=e.data};e.socket.onmessage=c;var l=nowNs();e.socket.send("GETTIME "+t+(m!==h?" "+m:"")+"\n")}function l(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=m;setTimeout(function(){var e=nowMs(),n=e-s;p.debug("diff:"+(n-t)+" ("+(n-t)/t+" %)")},t);!function i(){g(e,o,a,function(u){if(r+=o*a,p.debug(e.id+": "+u),nowMs()-s>t){e.socket.onmessage=n;var d=parseInt(u.substring(5));D.push(o*a/(d/1e9))}else{var c=2*a;o<8||!A.hasOwnProperty(c)||!I?(o*=2,i()):(a=Math.min(2*a,_),i())}})}()}function g(e,t,n,s){var o=e.socket;o.onmessage=function(e){0!==e.data.indexOf("OK")&&0!==e.data.indexOf("ACCEPT")&&s(e.data)},p.debug(e.id+": uploading "+t+" chunks, "+n*t/1e3+" KB"),o.send("PUTNORESULT"+(I?" "+n:"")+"\n");for(var r=0;r<t;r++){var a=void 0;a=r===t-1?A[n]:y[n][0],o.send(a)}}function T(e,t){var n=e.socket.onmessage,s=G/2/U,o=Math.ceil(G/U/m),r=!1,a=!0,i=-1,u=0,d=function s(){r||(p.debug(e.id+": is 7.2 sec in, got data for "+i),i<1e9*t&&u<3e3?(setTimeout(s,250),u+=250):(p.debug(e.id+": didn't finish, timeout extended by "+u+" ms, last info for "+i),e.socket.onerror=function(){},e.socket.onclose=function(){},e.socket.close(),e.socket.onmessage=n,p.debug(e.id+": socket now closed: "+e.socket.readyState),e.triggerNextState()))},c=function t(){if(e.socket.bufferedAmount<s)for(var n=0;n<o;n++)e.socket.send(y[m][n%y[m].length]);if(!a)return!1;setTimeout(t,0)};setTimeout(d,1e3*t+200),setTimeout(function(){a=!1,e.socket.onclose=function(){},e.socket.send(A[m]),e.socket.send("QUIT\n")},1e3*t),p.debug(e.id+": set timeout");var l=1e6*S.measurementPointsTimespan,g=/TIME (\d+) BYTES (\d+)/,T=/TIME (\d+)/,f=function(t){"OK\n"===t.data&&c();var s=g.exec(t.data);if(null!==s){var o={duration:parseInt(s[1]),bytes:parseInt(s[2])};o.duration-i>l&&(i=o.duration,e.result.up.push(o))}else null!==(s=T.exec(t.data))&&(r=!0,p.debug("Upload duration: "+s[1]),e.socket.onmessage=n)};e.socket.onmessage=f,e.socket.send("PUT"+(m!==h?" "+m:"")+"\n")}function f(e){return{client_language:"de",client_name:S.client,client_uuid:S.uuid,client_version:S.client_version,client_software_version:S.client_software_version,geoLocations:N.geoLocations,model:S.model,network_type:98,platform:S.platform,product:S.product,pings:N.pings,test_bytes_download:N.bytes_download,test_bytes_upload:N.bytes_upload,test_nsec_download:N.nsec_download,test_nsec_upload:N.nsec_upload,test_num_threads:C,num_threads_ul:U,test_ping_shortest:N.ping_server_shortest,test_speed_download:N.speed_download,test_speed_upload:N.speed_upload,test_token:e.test_token,test_uuid:e.test_uuid,time:N.beginTime,timezone:S.timezone,type:"DESKTOP",version_code:"1",speed_detail:N.speedItems,user_server_selection:S.userServerSelection}}var p=log.getLogger("rmbtws"),m=null,_=4194304,v=0,h=4096,I=!1,S=void 0,k=void 0,N=null,b=null,E=null,M=TestState.INIT,w=null,O={durationInitMs:2500,durationPingMs:1e4,durationUpMs:-1,durationDownMs:-1},P=new RMBTIntermediateResult,R=[],y={},A={},L=null,B=0,C=0,U=0,D=[],G=0;this.onError=function(e){b=e},this.onStateChange=function(e){E=e};var x=function(e){if(p.debug("error occurred during websocket test:",e),e!==RMBTError.NOT_SUPPORTED&&n(TestState.ERROR),null!==b){var t=b;b=null,t(e)}};this.startTest=function(){n(TestState.INIT),N=new RMBTTestResult,k.getDataCollectorInfo(),k.obtainControlServerRegistration(function(e){B=parseInt(e.test_numthreads),L=new CyclicBarrier(B),O.durationDownMs=1e3*e.test_duration,O.durationUpMs=1e3*e.test_duration,null!==TestEnvironment.getTestVisualization()&&TestEnvironment.getTestVisualization().updateInfo(e.test_server_name,e.client_remote_ip,e.provider,e.test_uuid,e.open_test_uuid);var t=function(){p.debug("got geolocation, obtaining token and websocket address");var t=function(){n(TestState.INIT),N.beginTime=Date.now();for(var t=0;t<B;t++){var r=new RMBTTestThread(L);r.id=t,N.addThread(r.result),s(e,r,function(){p.info("All tests finished"),o.stop(),N.geoLocations=o.getResults(),N.calculateAll(),k.submitResults(f(e),function(){n(TestState.END)},function(){x(RMBTError.SUBMIT_FAILED)})}),R.push(r)}};0===e.test_wait?t():(p.info("test scheduled for start in "+e.test_wait+" second(s)"),n(TestState.WAIT),self.setTimeout(function(){t()},1e3*e.test_wait))},o=void 0;null!==TestEnvironment.getGeoTracker()?(o=TestEnvironment.getGeoTracker(),t()):(o=new GeoTracker,p.debug("getting geolocation"),o.start(function(){t()},TestEnvironment.getTestVisualization()))},function(){x(RMBTError.REGISTRATION_FAILED)})},this.getIntermediateResult=function(){P.status=M;var e=nowNs()/1e6-w;switch(P.status){case TestState.WAIT:P.progress=0;break;case TestState.INIT:case TestState.INIT_DOWN:case TestState.INIT_UP:P.progress=e/O.durationInitMs;break;case TestState.PING:P.progress=e/O.durationPingMs;break;case TestState.DOWN:P.progress=e/O.durationDownMs;break;case TestState.UP:P.progress=e/O.durationUpMs;break;case TestState.END:P.progress=1;break;case TestState.ERROR:case TestState.ABORTED:P.progress=0}if(isNaN(P.progress)&&(P.progress=0),P.progress=Math.min(1,P.progress),null!==N){if(P.status!==TestState.PING&&P.status!==TestState.DOWN||(P.pingNano=N.ping_server_median,P.pings=N.pings),P.status===TestState.DOWN||P.status==TestState.INIT_UP){var t=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(N.threads,function(e){return e.down});P.downBitPerSec=t.speed,P.downBitPerSecLog=(Math.log10(P.downBitPerSec/1e6)+2)/4}if(P.status===TestState.UP||P.status==TestState.INIT_UP){var n=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(N.threads,function(e){return e.up});P.upBitPerSec=n.speed,P.upBitPerSecLog=(Math.log10(P.upBitPerSec/1e6)+2)/4}}return P},this.getState=function(){return"INIT"},function(e,t){S=e,k=t}(e,t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.RMBTTest=RMBTTest;
"use strict";function runCallback(){void 0!=geo_callback&&"function"==typeof geo_callback&&setTimeout(function(){geo_callback()},1)}function getCurLocation(){return curGeoPos}function getLocation(o,t,e,n){if(geo_callback=n,!navigator.geolocation){var a=getCookie("coords");if(a){var i=JSON.parse(a);i&&i.lat>0&&i.long>0&&testVisualization.setLocation(i.lat,i.long)}return void runCallback()}runCallback(),TestEnvironment.getGeoTracker().start(function(){},TestEnvironment.getTestVisualization())}var curGeoPos=void 0,geo_callback=void 0,loc_timeout=void 0,GeoTracker=function(){function o(){t=[],i=!1}var t=void 0,e=void 0,n=null,a=void 0,i=void 0;o.prototype.start=function(o,l){if(e=o,void 0!==l&&(n=l),navigator.geolocation)navigator.geolocation.getCurrentPosition(function(o){0===t.length&&(i=!0,c(o))},r,{enableHighAccuracy:!1,timeout:2e3,maximumAge:6e4}),a=navigator.geolocation.watchPosition(c,r,{enableHighAccuracy:!0,timeout:1/0,maximumAge:0});else{var u=e;e=null,u(!1)}setTimeout(function(){r()},2e3)};var c=function(o){if(1===t.length&&i&&(t=[],i=!1),t.push({geo_lat:o.coords.latitude,geo_long:o.coords.longitude,accuracy:o.coords.accuracy,altitude:o.coords.altitude,bearing:o.coords.heading,speed:o.coords.speed,tstamp:o.timestamp,provider:"Browser"}),null!==e){var a=e;e=null,a(!0)}null!==n&&n.setLocation(o.coords.latitude,o.coords.longitude),l(o)},r=function(o){if(null!==e){var t=e;e=null,t(!1,o)}},l=function(o){var t={};t.lat=o.coords.latitude,t.long=o.coords.longitude,t.accuracy=o.coords.accuracy,t.altitude=o.coords.altitude,t.heading=o.coords.heading,t.speed=o.coords.speed,t.tstamp=o.timestamp,t=JSON.stringify(t),setCookie("coords",t,3600)};return o.prototype.stop=function(){navigator.geolocation&&navigator.geolocation.clearWatch(a)},o.prototype.getResults=function(){var o=null;return t=t.filter(function(t){return null==o?(o=t,!0):!Object.keys(t).every(function(e){return o.hasOwnProperty(e)&&o[e]===t[e]})&&(o=t,!0)})},o}();
