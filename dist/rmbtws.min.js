 ...
 *****************************************************************************!*/
"use strict";var RMBTTest=function(){function e(e,t,n){I=e,k=t,w=TestState.INIT,n||(n=new Logger),f=n}function t(e){void 0!==w&&w===e||(w=e,N=nowMs())}function n(e,n,a){var u=(e.test_server_encryption?"wss://":"ws://")+e.test_server_address+":"+e.test_server_port;f.debug(u);var l=function(){return{IGNORE:function(){},CALLGLOBALHANDLER:function(){A(RMBTError.CONNECT_FAILED)},TRYRECONNECT:function(){A(RMBTError.CONNECT_FAILED)}}}();n.onStateEnter(TestState.INIT_DOWN,function(){t(TestState.INIT_DOWN),f.debug(n.id+": start short download"),p=m,r(n,I.pretestDurationMs)}),n.onStateEnter(TestState.PING,function(){t(TestState.PING),f.debug(n.id+": starting ping"),0===n.id?i(n):n.triggerNextState()}),n.onStateEnter(TestState.DOWN,function(){if(t(TestState.DOWN),C.length>0){var s=o(C,I.downloadThreadsLimitsMbit,!1);B=s.numThreads,p=s.chunkSize,C=[]}n.id<B?d(n,e.test_duration):n.triggerNextState()}),n.onStateEnter(TestState.INIT_UP,function(){t(TestState.INIT_UP),p=m,c(n,I.pretestDurationMs)}),n.onStateEnter(TestState.UP,function(){if(t(TestState.UP),C.length>0){var s=o(C,I.uploadThreadsLimitsMbit,!0);L=s.numThreads,p=s.chunkSize,C=[]}n.id<L?g(n,e.test_duration):(n.socket.onerror=l.IGNORE,n.socket.readyState!==WebSocket.CLOSED&&n.socket.close(),n.triggerNextState())}),n.onStateEnter(TestState.END,function(){n.socket.readyState!==WebSocket.CLOSED&&n.socket.close(),0===n.id&&a()}),n.setState(TestState.INIT),t(TestState.INIT),s(n,u,e.test_token,l.CALLGLOBALHANDLER)}function s(e,t,n,s){try{e.socket=new WebSocket(t)}catch(e){return void A(RMBTError.SOCKET_INIT_FAILED)}e.socket.binaryType="arraybuffer",e.socket.onerror=s,e.socket.onmessage=function(t){if(0===t.data.indexOf("CHUNKSIZE")){var o=t.data.trim().split(" ");4===o.length?(S=parseInt(o[1]),m=parseInt(o[2]),v=parseInt(o[3])):(S=parseInt(o[1]),m=S),f.debug(e.id+": Chunksizes: min "+m+", max: "+v+", default: "+S)}else if(0===t.data.indexOf("RMBTv")){var r=t.data.substring(5).trim();I.client_version=r,0===r.indexOf("1.")?_=!0:0===r.indexOf("0.3")?_=!1:f.warn("unknown server version: "+r)}else"ACCEPT TOKEN QUIT\n"===t.data?e.socket.send("TOKEN "+n+"\n"):"OK\n"===t.data&&e.state===TestState.INIT?f.debug(e.id+": Token accepted"):"ERR\n"===t.data?(s(),f.error("got error msg")):0===t.data.indexOf("ACCEPT GETCHUNKS")&&e.triggerNextState()}}function o(e,t,n){D=e.reduce(function(e,t){return e+t}),f.debug("total: circa "+D/1e3+" KB/sec"),f.debug("total: circa "+8*D/1e6+" MBit/sec");var s=8*D/1e6,o=0;Object.keys(t).forEach(function(e){s>e&&(o=t[e])}),o=Math.min(U,o),f.debug("set number of threads to be used in upcoming speed test to: "+o);var r=D/(1e3/(I.measurementPointsTimespan/2));if(r-=r%1024,r=Math.max(m,r),r=Math.min(v,r),f.debug("calculated chunksize for upcoming speed test "+r/1024+" KB"),n){var a=Number.POSITIVE_INFINITY;Object.keys(P).forEach(function(e){Math.abs(r-e)<Math.abs(r-a)?("string"==typeof e&&(e=parseInt(e)),a=e):(delete P[e],delete R[e])}),r=a,f.debug("fallback to existing chunksize for upcoming speed test "+r/1024+" KB")}return{numThreads:o,chunkSize:r,bytesPerSecs:D}}function r(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,i=p;!function u(){a(e,o,i,function(a){r+=o*i,f.debug(e.id+": "+a);var d=parseInt(a.substring(5));nowMs()-s>t?(C.push(o*i/(d/1e9)),e.socket.onmessage=n):o<8||!_?(o*=2,u()):(i=Math.min(2*i,v),u())})}()}function a(e,t,n,s){var o=e.socket,r=t,a=p*t,i=0,u=null,d=function(e,t){var n=new Uint8Array(e.length+t.length);return n.set(e,0),n.set(t,e.length),n},c=function(e){if("string"!=typeof e.data){var t=!1;u=null==u?new Uint8Array(e.data):d(u,new Uint8Array(e.data)),i+=e.data.byteLength,u.length===n&&(r--,t=!0),t&&255==u[u.length-1]?(o.onmessage=function(e){var t=e.data;s(t)},o.send("OK\n"),R[n]=u.buffer,u=null):(P.hasOwnProperty(n)||(P[n]=[]),t&&(P[n].length<I.savedChunks&&P[n].push(u.buffer),u=null))}};o.onmessage=c,f.debug(e.id+": downloading "+t+" chunks, "+a/1e3+" KB");var l="GETCHUNKS "+t+(n!==S?" "+n:"")+"\n";o.send(l)}function i(e){var t=1/0,n=e.socket.onmessage,s=I.numPings;u(e,function o(r){if(s--,e.result.pings.push(r),r.client<t&&(t=r.client),f.debug(e.id+": PING "+r.client+" ns client; "+r.server+" ns server"),s>0)e.socket.onmessage=function(t){"ACCEPT GETCHUNKS GETTIME PUT PUTNORESULT PING QUIT\n"===t.data?u(e,o):f.error("unexpected error during ping test")};else{for(var a=[],i=0;i<e.result.pings.length;i++)a.push(e.result.pings[i].client);b.ping_median=Math.median(a),f.debug(e.id+": shortest: "+Math.round(t/1e3)/1e3+" ms"),b.ping_shortest=t,e.socket.onmessage=n}})}function u(e,t){var n=void 0,s=void 0,o=function(o){if("PONG\n"===o.data){var r=nowNs();s=r-n,e.socket.send("OK\n")}else if(0===o.data.indexOf("TIME")){var a=new RMBTPingResult;a.client=s,a.server=parseInt(o.data.substring(5)),a.timeNs=n,t(a)}};e.socket.onmessage=o,n=nowNs(),e.socket.send("PING\n")}function d(e,t){var n=e.socket.onmessage,s=0,o=0,r=-1,a=void 0,i=void 0,u=null,d=null;a=window.setInterval(function(){if(null!==u&&r!==o){r=o;var t=nowNs();f.debug(e.id+": "+i+"|"+I.measurementPointsTimespan+"|"+t+"|"+o);var c=new Uint8Array(u,u.byteLength-1,1),g=d-l;e.result.down.push({duration:g,bytes:s}),i=t,c[0]>=255&&(f.debug(e.id+": received end chunk"),window.clearInterval(a),e.socket.onmessage=function(t){f.debug(t.data),e.socket.onmessage=n},e.socket.send("OK\n"))}},I.measurementPointsTimespan);var c=function(e){o++,s+=e.data.byteLength,d=nowNs(),u=e.data};e.socket.onmessage=c;var l=nowNs();e.socket.send("GETTIME "+t+(p!==S?" "+p:"")+"\n")}function c(e,t){var n=e.socket.onmessage,s=nowMs(),o=1,r=0,a=p;window.setTimeout(function(){var e=nowMs(),n=e-s;f.debug("diff:"+(n-t)+" ("+(n-t)/t+" %)")},t);!function i(){l(e,o,a,function(u){if(r+=o*a,f.debug(e.id+": "+u),nowMs()-s>t){e.socket.onmessage=n;var d=parseInt(u.substring(5));C.push(o*a/(d/1e9))}else{var c=2*a;o<8||!R.hasOwnProperty(c)||!_?(o*=2,i()):(a=Math.min(2*a,v),i())}})}()}function l(e,t,n,s){var o=e.socket;o.onmessage=function(e){0!==e.data.indexOf("OK")&&0!==e.data.indexOf("ACCEPT")&&s(e.data)},f.debug(e.id+": uploading "+t+" chunks, "+n*t/1e3+" KB"),o.send("PUTNORESULT"+(_?" "+n:"")+"\n");for(var r=0;r<t;r++){var a=void 0;a=r===t-1?R[n]:P[n][0],o.send(a)}}function g(e,t){var n=e.socket.onmessage,s=D/2/L,o=Math.ceil(D/L/p),r=!1,a=!0,i=-1,u=0,d=function s(){r||(f.debug(e.id+": is 7.2 sec in, got data for "+i),i<1e9*t&&u<3e3?(window.setTimeout(s,250),u+=250):(f.debug(e.id+": didn't finish, timeout extended by "+u+" ms, last info for "+i),e.socket.onerror=function(){},e.socket.close(),e.socket.onmessage=n,f.debug(e.id+": socket now closed: "+e.socket.readyState),e.triggerNextState()))},c=function t(){if(e.socket.bufferedAmount<s)for(var n=0;n<o;n++)e.socket.send(P[p][n%P[p].length]);if(!a)return!1;setTimeout(t,0)};window.setTimeout(d,1e3*t+200),window.setTimeout(function(){a=!1,e.socket.send(R[p]),e.socket.send("QUIT\n")},1e3*t),f.debug(e.id+": set timeout");var l=/TIME (\d+) BYTES (\d+)/,g=/TIME (\d+)/,T=function(t){"OK\n"===t.data&&c();var s=l.exec(t.data);if(null!==s){var o={duration:parseInt(s[1]),bytes:parseInt(s[2])};i=o.duration,e.result.up.push(o)}else null!==(s=g.exec(t.data))&&(r=!0,f.debug("Upload duration: "+s[1]),e.socket.onmessage=n)};e.socket.onmessage=T,e.socket.send("PUT"+(p!==S?" "+p:"")+"\n")}function T(e){return{client_language:"de",client_name:I.client,client_uuid:I.uuid,client_version:I.client_version,client_software_version:I.client_software_version,geoLocations:b.geoLocations,model:I.model,network_type:98,platform:I.platform,product:I.product,pings:b.pings,test_bytes_download:b.bytes_download,test_bytes_upload:b.bytes_upload,test_nsec_download:b.nsec_download,test_nsec_upload:b.nsec_upload,test_num_threads:B,num_threads_ul:L,test_ping_shortest:b.ping_shortest,test_speed_download:b.speed_download,test_speed_upload:b.speed_upload,test_token:e.test_token,test_uuid:e.test_token.split("_")[0],time:b.beginTime,timezone:"Europe/Vienna",type:"DESKTOP",version_code:"1",speed_detail:b.speedItems,user_server_selection:I.userServerSelection}}var f=null,p=void 0,v=4194304,m=void 0,S=void 0,_=!1,I=void 0,k=void 0,b=null,h=null,w=void 0,N=void 0,E={durationInitMs:2500,durationPingMs:500,durationUpMs:-1,durationDownMs:-1},M=new RMBTIntermediateResult,O=[],P={},R={},y=void 0,U=void 0,B=0,L=0,C=[],D=0;e.prototype.onError=function(e){h=e};var A=function(e){if(!e===RMBTError.NOT_SUPPORTED&&t(TestState.ERROR),null!==h){var n=h;h=null,n()}};return e.prototype.startTest=function(){if(void 0===window.WebSocket)return void A(RMBTError.NOT_SUPPORTED);t(TestState.INIT),b=new RMBTTestResult,k.getDataCollectorInfo(I),k.obtainControlServerRegistration(I,function(e){U=parseInt(e.test_numthreads),y=new CyclicBarrier(U),E.durationDownMs=1e3*e.test_duration,E.durationUpMs=1e3*e.test_duration,null!==TestEnvironment.getTestVisualization()&&TestEnvironment.getTestVisualization().updateInfo(e.test_server_name,e.client_remote_ip,e.provider,e.test_uuid);var s=function(){f.debug("got geolocation, obtaining token and websocket address"),t(TestState.WAIT),window.setTimeout(function(){t(TestState.INIT),b.beginTime=Date.now();for(var s=0;s<U;s++){var r=new RMBTTestThread(y);r.id=s,b.addThread(r.result),n(e,r,function(){f.info("All tests finished"),o.stop(),b.geoLocations=o.getResults(),b.calculateAll(),k.submitResults(I.controlServerURL+I.controlServerResultResource,T(e),function(){t(TestState.END)})}),O.push(r)}},1e3*e.test_wait)},o=void 0;null!==TestEnvironment.getGeoTracker()?(o=TestEnvironment.getGeoTracker(),s()):(o=new GeoTracker,f.debug("getting geolocation"),o.start(function(){s()}))})},e.prototype.getIntermediateResult=function(){M.status=w;var e=nowNs()/1e6-N;switch(M.status){case TestState.WAIT:M.progress=0;break;case TestState.INIT:case TestState.INIT_DOWN:case TestState.INIT_UP:M.progress=e/E.durationInitMs;break;case TestState.PING:M.progress=e/E.durationPingMs;break;case TestState.DOWN:M.progress=e/E.durationDownMs;break;case TestState.UP:M.progress=e/E.durationUpMs;break;case TestState.END:M.progress=1;break;case TestState.ERROR:case TestState.ABORTED:M.progress=0}if(isNaN(M.progress)&&(M.progress=0),M.progress=Math.min(1,M.progress),null!==b){if(M.pingNano=b.ping_median,M.status===TestState.DOWN){var t=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(b.threads,function(e){return e.down});M.downBitPerSec=t.speed,M.downBitPerSecLog=(Math.log10(M.downBitPerSec/1e6)+2)/4}if(M.status===TestState.UP){var n=RMBTTestResult.calculateOverallSpeedFromMultipleThreads(b.threads,function(e){return e.up});M.upBitPerSec=n.speed,M.upBitPerSecLog=(Math.log10(M.upBitPerSec/1e6)+2)/4}}return M},e.prototype.getState=function(){return"INIT"},e}();
...
"use strict";var RMBTControlServerCommunication=function(){function e(){this.logger=new Logger}return e.prototype.logger=null,e.prototype.obtainControlServerRegistration=function(e,r){var t={version:e.version,language:e.language,uuid:e.uuid,type:e.type,version_code:e.version_code,client:e.client,timezone:e.timezone,time:(new Date).getTime()};"undefined"!=typeof userServerSelection&&userServerSelection>0&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(t.prefer_server=UserConf.preferredServer,t.user_server_selection=userServerSelection),$.ajax({url:e.controlServerURL+e.controlServerRegistrationResource,type:"post",dataType:"json",contentType:"application/json",data:JSON.stringify(t),success:function(e){var t=new RMBTControlServerRegistrationResponse(e);r(t)},error:function(){this.logger.error("error getting testID")}})},e.prototype.getDataCollectorInfo=function(e){$.ajax({url:e.controlServerURL+e.controlServerDataCollectorResource,type:"get",dataType:"json",contentType:"application/json",success:function(r){e.product=r.agent.substring(0,Math.min(150,r.agent.length)),e.model=r.product,e.os_version=r.version},error:function(){this.logger.error("error getting data collection response")}})},e.prototype.submitResults=function(e,r,t){var o=this,n=JSON.stringify(r);this.logger.debug("Submit size: "+n.length),$.ajax({url:e,type:"post",dataType:"json",contentType:"application/json",data:n,success:function(e){o.logger.debug("https://develop.netztest.at/en/Verlauf?"+r.test_uuid),t()},error:function(){o.logger.error("error submitting results")}})},e}();
