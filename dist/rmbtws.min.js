...
"use strict";var RMBTControlServerCommunication=function(){function e(e){this._logger=new Logger,this._rmbtTestConfig=e}return e.prototype._logger=null,e.prototype._rmbtTestConfig=null,e.prototype.obtainControlServerRegistration=function(e){var t={version:this._rmbtTestConfig.version,language:this._rmbtTestConfig.language,uuid:this._rmbtTestConfig.uuid,type:this._rmbtTestConfig.type,version_code:this._rmbtTestConfig.version_code,client:this._rmbtTestConfig.client,timezone:this._rmbtTestConfig.timezone,time:(new Date).getTime()};"undefined"!=typeof userServerSelection&&userServerSelection>0&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(t.prefer_server=UserConf.preferredServer,t.user_server_selection=userServerSelection),$.ajax({url:this._rmbtTestConfig.controlServerURL+this._rmbtTestConfig.controlServerRegistrationResource,type:"post",dataType:"json",contentType:"application/json",data:JSON.stringify(t),success:function(t){var r=new RMBTControlServerRegistrationResponse(t);e(r)},error:function(){this._logger.error("error getting testID")}})},e.prototype.getDataCollectorInfo=function(){var e=this;$.ajax({url:this._rmbtTestConfig.controlServerURL+this._rmbtTestConfig.controlServerDataCollectorResource,type:"get",dataType:"json",contentType:"application/json",success:function(t){e._rmbtTestConfig.product=t.agent.substring(0,Math.min(150,t.agent.length)),e._rmbtTestConfig.model=t.product,e._rmbtTestConfig.os_version=t.version},error:function(){this._logger.error("error getting data collection response")}})},e.prototype.submitResults=function(e,t){var r=this,o=JSON.stringify(e);this._logger.debug("Submit size: "+o.length),$.ajax({url:this._rmbtTestConfig.controlServerURL+this._rmbtTestConfig.controlServerResultResource,type:"post",dataType:"json",contentType:"application/json",data:o,success:function(o){r._logger.debug("https://develop.netztest.at/en/Verlauf?"+e.test_uuid),t()},error:function(){r._logger.error("error submitting results")}})},e}();
