...
"use strict";var RMBTControlServerCommunication=function(){function e(e){t=e,r=log.getLogger("rmbtws")}var r=void 0,t=void 0;return e.prototype.obtainControlServerRegistration=function(e){var o={version:t.version,language:t.language,uuid:t.uuid,type:t.type,version_code:t.version_code,client:t.client,timezone:t.timezone,time:(new Date).getTime()};"undefined"!=typeof userServerSelection&&userServerSelection>0&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(o.prefer_server=UserConf.preferredServer,o.user_server_selection=userServerSelection),$.ajax({url:t.controlServerURL+t.controlServerRegistrationResource,type:"post",dataType:"json",contentType:"application/json",data:JSON.stringify(o),success:function(r){var t=new RMBTControlServerRegistrationResponse(r);e(t)},error:function(){r.error("error getting testID")}})},e.prototype.getDataCollectorInfo=function(){$.ajax({url:t.controlServerURL+t.controlServerDataCollectorResource,type:"get",dataType:"json",contentType:"application/json",success:function(e){t.product=e.agent.substring(0,Math.min(150,e.agent.length)),t.model=e.product,t.os_version=e.version},error:function(){r.error("error getting data collection response")}})},e.prototype.submitResults=function(e,o){var n=JSON.stringify(e);r.debug("Submit size: "+n.length),$.ajax({url:t.controlServerURL+t.controlServerResultResource,type:"post",dataType:"json",contentType:"application/json",data:n,success:function(t){r.debug("https://develop.netztest.at/en/Verlauf?"+e.test_uuid),o()},error:function(){r.error("error submitting results")}})},e}();
...
"use strict";function nowMs(){return window.performance.now()}function nowNs(){return Math.round(1e6*window.performance.now())}!function(){if(Date.now||(Date.now=function(){return(new Date).getTime()}),void 0===window.performance&&(window.performance={}),!window.performance.now||void 0===window.performance.now){var n=Date.now();performance.timing&&performance.timing.navigationStart&&(n=performance.timing.navigationStart),window.performance.now=function(){return Date.now()-n}}}();var CyclicBarrier=function(){function n(n){r=n}function o(){var n=e.slice();e=[];for(var o=0;o<r;o++)window.setTimeout(n[o],1)}var r=void 0,e=[];return n.prototype.await=function(n){e.push(n),e.length===r&&o()},n}();Math.median=function(n){n.sort(function(n,o){return n-o});var o=Math.floor(n.length/2);return n.length%2?n[o]:(n[o-1]+n[o])/2},Math.log10=Math.log10||function(n){return Math.log(n)/Math.LN10},self.log=self.log||{debug:console.log,trace:console.trace,info:console.info,warn:console.warn,error:console.error,setLevel:function(){},getLogger:function(){return log}};
