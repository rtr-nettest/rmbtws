 ...
 *****************************************************************************!*/
"use strict";function debug_without_newline(e){$("#debug").append(e)}var debug=function(e){$("#debug").prepend(e+"\n"),console.log(e)},server_override="wss://developv4-rmbtws.netztest.at:19002",RMBTTest=function(){function e(e){m=e}function t(e){void 0!==E&&E===e||(E=e,S=performance.now())}function n(e,n,r){var i=(e.test_server_encryption?"wss://":"ws://")+e.test_server_address+":"+e.test_server_port;debug(i);var c=function(){return{IGNORE:function(){},CALLGLOBALHANDLER:function(){D(RMBTError.CONNECT_FAILED)},TRYRECONNECT:function(){D(RMBTError.CONNECT_FAILED)}}}();n.onStateEnter(TestState.INIT_DOWN,function(){t(TestState.INIT_DOWN),debug(n.id+": start short download"),0===n.id?o(n,m.pretestDurationMs):n.triggerNextState()}),n.onStateEnter(TestState.PING,function(){t(TestState.PING),debug(n.id+": starting ping"),0===n.id?a(n):n.triggerNextState()}),n.onStateEnter(TestState.DOWN,function(){t(TestState.DOWN),B&&0!==n.id?n.triggerNextState():d(n,e.test_duration)}),n.onStateEnter(TestState.INIT_UP,function(){t(TestState.INIT_UP),T=v,0===n.id?u(n,m.pretestDurationMs):n.triggerNextState()}),n.onStateEnter(TestState.UP,function(){t(TestState.UP),!C&&!m.limitUploadThreads||0===n.id?g(n,e.test_duration):(n.socket.onerror=c.IGNORE,n.triggerNextState())}),n.onStateEnter(TestState.END,function(){0===n.id&&r()}),n.setState(TestState.INIT),t(TestState.INIT),s(n,i,e.test_token,c.CALLGLOBALHANDLER)}function s(e,t,n,s){try{e.socket=new WebSocket(t)}catch(e){return void D(RMBTError.SOCKET_INIT_FAILED)}e.socket.binaryType="arraybuffer",e.socket.onerror=s,e.socket.onmessage=function(t){if(0===t.data.indexOf("CHUNKSIZE"))T=parseInt(t.data.substring(10)),v=T,debug(e.id+"Chunksize: "+T);else if(0===t.data.indexOf("RMBTv")){var o=t.data.substring(5).trim();m.client_version=o,0===o.indexOf("1.")?N=!0:0===o.indexOf("0.3")?N=!1:debug("unknown server version: "+o)}else"ACCEPT TOKEN QUIT\n"===t.data?e.socket.send("TOKEN "+n+"\n"):"OK\n"===t.data&&e.state===TestState.INIT?debug(e.id+": Token accepted"):"ERR\n"===t.data?(s(),debug("got error msg")):0===t.data.indexOf("ACCEPT GETCHUNKS")&&e.triggerNextState()}}function o(e,t){var n=e.socket.onmessage,s=performance.now(),o=1,a=0;!function i(){r(e,o,function(r){a+=o*T,debug(e.id+": "+r);var d=parseInt(r.substring(5));if(performance.now()-s>t){o<=m.fallbackChunksDownload&&(B=!0),w=o*T/(d/1e9),debug(e.id+": circa "+w/1e3+" KB/sec"),debug(e.id+": circa "+8*w/1e6+" MBit/sec");var u=w/(1e3/(m.measurementPointsTimespan/2*_));u-=u%1024,u=Math.max(v,u),debug(e.id+": calculated chunksize for download speed test "+u/1024+" KB"),T=u,e.socket.onmessage=n}else o<8||!N?(o*=2,i()):(T=Math.min(2*T,I),i())})}()}function r(e,t,n){var s=e.socket,o=t,r=T*t,a=0,i=function(e){"string"!=typeof e.data&&(a+=e.data.byteLength,e.data.byteLength!==T&&1!==e.data.byteLength||o--,0===o?(s.onmessage=function(e){var t=e.data;n(t)},s.send("OK\n"),U[T]=e.data):(P.hasOwnProperty(T)||(P[T]=[]),P[T].push(e.data)))};s.onmessage=i,debug(e.id+": downloading "+t+" chunks, "+r/1e3+" KB");var d="GETCHUNKS "+t+(T!==v?" "+T:"")+"\n";s.send(d)}function a(e){var t=1/0,n=e.socket.onmessage,s=m.numPings;i(e,function o(r){if(s--,e.result.pings.push(r),r.client<t&&(t=r.client),debug(e.id+": PING "+r.client+" ns client; "+r.server+" ns server"),s>0)e.socket.onmessage=function(t){"ACCEPT GETCHUNKS GETTIME PUT PUTNORESULT PING QUIT\n"===t.data?i(e,o):debug("unexpected error during ping test")};else{for(var a=[],d=0;d<e.result.pings.length;d++)a.push(e.result.pings[d].client);h.ping_median=Math.median(a),debug(e.id+": shortest: "+Math.round(t/1e3)/1e3+" ms"),h.ping_shortest=t,e.socket.onmessage=n}})}function i(e,t){var n,s,o=function(o){if("PONG\n"===o.data){var r=nowNs();s=r-n,e.socket.send("OK\n")}else if(0===o.data.indexOf("TIME")){var a=new RMBTPingResult;a.client=s,a.server=parseInt(o.data.substring(5)),a.timeNs=n,t(a)}};e.socket.onmessage=o,n=nowNs(),e.socket.send("PING\n")}function d(e,t){var n,s,o=e.socket.onmessage,r=0,a=0,i=-1,d=null;n=window.setInterval(function(){if(null!==d&&i!==a){i=a;var t=nowNs();debug(e.id+": "+s+"|"+m.measurementPointsTimespan+"|"+t+"|"+a);var u=new Uint8Array(d,d.byteLength-1,1),t=nowNs(),g=t-c;e.result.down.push({duration:g,bytes:r}),s=t,u[0]>=255?(debug(e.id+": received end chunk"),window.clearInterval(n),e.socket.onmessage=function(t){debug(t.data),e.socket.onmessage=o},e.socket.send("OK\n")):M.length<10&&M.push(d)}},m.measurementPointsTimespan);var u=function(e){a++,r+=e.data.byteLength,d=e.data};e.socket.onmessage=u;var c=nowNs();e.socket.send("GETTIME "+t+(T!==v?" "+T:"")+"\n")}function u(e,t){var n=e.socket.onmessage,s=performance.now(),o=1,r=0;window.setTimeout(function(){var e=performance.now(),n=e-s;debug("diff:"+(n-t)+" ("+(n-t)/t+" %)")},t);!function a(){c(e,o,function(i){if(r+=o*T,debug(e.id+": "+i),performance.now()-s>t){o<=m.fallbackChunksUpload&&(C=!0),e.socket.onmessage=n;var d=parseInt(i.substring(5));w=o*T/(d/1e9),debug(e.id+": circa "+w/1e3+" KB/sec up"),debug(e.id+": circa "+8*w/1e6+" MBit/sec up");var u=w/(1e3/(m.measurementPointsTimespan/2*_));u-=u%1024,u=Math.max(v,u);var c=Number.POSITIVE_INFINITY;Object.keys(P).forEach(function(e){Math.abs(u-e)<Math.abs(u-c)&&(c=e)}),debug(e.id+": calculated chunksize for upload speed test "+u/1024+" KB"),debug(e.id+": used chunk size for upload test will be: "+c/1024+" KB"),T=c}else{var g=2*T;o<8||!U.hasOwnProperty(g)||!N?(o*=2,a()):(T=Math.min(2*T,I),a())}})}()}function c(e,t,n){var s=e.socket;s.onmessage=function(e){0!==e.data.indexOf("OK")&&0!==e.data.indexOf("ACCEPT")&&n(e.data)},debug(e.id+": uploading "+t+" chunks, "+T*t/1e3+" KB"),s.send("PUTNORESULT"+(N?" "+T:"")+"\n");for(var o=0;o<t;o++){var r;r=o===t-1?U[T]:P[T][0],s.send(r)}}function g(e,t){var n=e.socket.onmessage,s=w/2/_,o=Math.ceil(w/_/T),r=!1,a=!0,i=-1,d=0,u=function s(){r||(debug(e.id+": is 7.2 sec in, got data for "+i),i<1e9*t&&d<3e3?(window.setTimeout(s,250),d+=250):(debug(e.id+": didn't finish, timeout extended by "+d+" ms, last info for "+i),e.socket.onerror=function(){},e.socket.close(),e.socket.onmessage=n,debug(e.id+": socket now closed: "+e.socket.readyState),e.triggerNextState()))},c=function t(){if(e.socket.bufferedAmount<s)for(var n=0;n<o;n++)e.socket.send(P[T][n%P[T].length]);if(!a)return!1;setTimeout(t,0)};window.setTimeout(u,1e3*t+200),window.setTimeout(function(){a=!1,e.socket.send(U[T]),e.socket.send("QUIT\n")},1e3*t),debug(e.id+": set timeout");var g=/TIME (\d+) BYTES (\d+)/,l=/TIME (\d+)/,p=function(t){"OK\n"===t.data&&c();var s=g.exec(t.data);if(null!==s){var o={duration:parseInt(s[1]),bytes:parseInt(s[2])};i=o.duration,e.result.up.push(o)}else null!==(s=l.exec(t.data))&&(r=!0,debug("Upload duration: "+s[1]),e.socket.onmessage=n)};e.socket.onmessage=p,e.socket.send("PUT"+(T!==v?" "+T:"")+"\n")}function l(e,t){var n={version:e.version,language:e.language,uuid:e.uuid,type:e.type,version_code:e.version_code,client:e.client,timezone:e.timezone,time:(new Date).getTime()};"undefined"!=typeof userServerSelection&&userServerSelection>0&&"undefined"!=typeof UserConf&&void 0!==UserConf.preferredServer&&"default"!==UserConf.preferredServer&&(n.prefer_server=UserConf.preferredServer,n.user_server_selection=userServerSelection),$.ajax({url:e.controlServerURL+e.controlServerRegistrationResource,type:"post",dataType:"json",contentType:"application/json",data:JSON.stringify(n),success:function(e){var n=new RMBTControlServerRegistrationResponse(e);t(n)},error:function(){debug("error getting testID")}})}function p(e){$.ajax({url:e.controlServerURL+e.controlServerDataCollectorResource,type:"get",dataType:"json",contentType:"application/json",success:function(t){e.product=t.agent.substring(0,Math.min(150,t.agent.length)),e.model=t.product,e.os_version=t.version},error:function(){debug("error getting data collection response")}})}function f(e,t){var n={client_language:"de",client_name:m.client,client_uuid:m.uuid,client_version:m.client_version,client_software_version:m.client_software_version,geoLocations:h.geoLocations,model:m.model,network_type:98,platform:m.platform,product:m.product,pings:h.pings,test_bytes_download:h.bytes_download,test_bytes_upload:h.bytes_upload,test_nsec_download:h.nsec_download,test_nsec_upload:h.nsec_upload,test_num_threads:B?1:_,num_threads_ul:C||m.limitUploadThreads?1:_,test_ping_shortest:h.ping_shortest,test_speed_download:h.speed_download,test_speed_upload:h.speed_upload,test_token:e.test_token,time:h.beginTime,timezone:"Europe/Vienna",type:"DESKTOP",version_code:"1",speed_detail:h.speedItems,user_server_selection:m.userServerSelection},s=JSON.stringify(n);debug("Submit size: "+s.length),$.ajax({url:m.controlServerURL+m.controlServerResultResource,type:"post",dataType:"json",contentType:"application/json",data:s,success:function(n){debug("https://develop.netztest.at/en/Verlauf?"+e.test_uuid),t()},error:function(){debug("error submitting results")}})}var T,v,m,S,b,_,w,I=4194304,N=!1,h=null,k=null,E=TestState.INIT,y={durationInitMs:2500,durationPingMs:500,durationUpMs:-1,durationDownMs:-1},O=new RMBTIntermediateResult,R=new Array,M=new Array,P={},U={},B=!1,C=!1;e.prototype.onError=function(e){k=e};var D=function(e){if(!e===RMBTError.NOT_SUPPORTED&&t(TestState.ERROR),null!==k){var n=k;k=null,n()}};return e.prototype.startTest=function(){if(void 0===window.WebSocket)return void D(RMBTError.NOT_SUPPORTED);t(TestState.INIT),h=new RMBTTestResult,p(m),l(m,function(e){_=parseInt(e.test_numthreads),b=new CyclicBarrier(_),y.durationDownMs=1e3*e.test_duration,y.durationUpMs=1e3*e.test_duration,null!==TestEnvironment.getTestVisualization()&&TestEnvironment.getTestVisualization().updateInfo(e.test_server_name,e.client_remote_ip,e.provider,e.test_uuid);var s,o=function(){debug("got geolocation, obtaining token and websocket address"),t(TestState.WAIT),window.setTimeout(function(){t(TestState.INIT),h.beginTime=Date().now;for(var o=0;o<_;o++){var r=new RMBTTestThread(b);r.id=o,h.addThread(r.result),n(e,r,function(){debug("All tests finished"),s.stop(),h.geoLocations=s.getResults(),h.calculateAll(),f(e,function(){t(TestState.END)})}),R.push(r)}},1e3*e.test_wait)};null!==TestEnvironment.getGeoTracker()?(s=TestEnvironment.getGeoTracker(),o()):(s=new GeoTracker,debug("getting geolocation"),s.start(function(){o()}))})},e.prototype.getIntermediateResult=function(){O.status=E;var e=performance.now()-S;switch(O.status){case TestState.WAIT:O.progress=0;break;case TestState.INIT:case TestState.WAIT:case TestState.INIT_DOWN:case TestState.INIT_UP:O.progress=e/y.durationInitMs;break;case TestState.PING:O.progress=e/y.durationPingMs;break;case TestState.DOWN:O.progress=e/y.durationDownMs;break;case TestState.UP:O.progress=e/y.durationUpMs;break;case TestState.END:O.progress=1;break;case TestState.ERROR:case TestState.ABORTED:O.progress=0}if(isNaN(O.progress)&&(O.progress=0),O.progress=Math.min(1,O.progress),null!==h){if(O.pingNano=h.ping_median,O.status===TestState.DOWN){for(var t=0,n=1/0,s=0;s<R.length>0;s++){var o=h.threads[s].down;o.length>0&&(t+=o[o.length-1].bytes,o[o.length-1].duration<n&&(n=o[o.length-1].duration))}O.downBitPerSec=Math.max(0,8*t/(n/1e9)),O.downBitPerSecLog=(log10(O.downBitPerSec/1e6)+2)/4}if(O.status===TestState.UP){t=0,n=1/0;for(var s=0;s<R.length;s++){var r=h.threads[s].up;r.length>0&&(t+=r[r.length-1].bytes,r[r.length-1].duration<n&&(n=r[r.length-1].duration))}O.upBitPerSec=Math.max(0,8*t/(n/1e9)),O.upBitPerSecLog=(log10(O.upBitPerSec/1e6)+2)/4}}return O},e.prototype.getState=function(){return"INIT"},e}(),config=new RMBTTestConfig;
"use strict";function RMBTTestConfig(){}function RMBTTestThread(t){var e={},s=t;return{setState:function(t){this.state=t,debug(this.id+": reached state: "+t);var o=this;s.await(function(){if(debug(o.id+": all threads reached state: "+t),void 0!==e[t]&&null!==e[t]){(0,e[t])()}else debug(o.id+": no callback registered")})},onStateEnter:function(t,s){e[t]=s},retriggerState:function(){setState(this.state)},triggerNextState:function(){var t=[TestState.INIT,TestState.INIT_DOWN,TestState.PING,TestState.DOWN,TestState.INIT_UP,TestState.UP,TestState.END];if(this.state!==TestState.END){var e=t[t.indexOf(this.state)+1];debug(this.id+": triggered state "+e),this.setState(e)}},id:-1,socket:null,result:new RMBTThreadTestResult}}function RMBTTestResult(){this.pings=new Array,this.speedItems=new Array,this.threads=new Array}function RMBTThreadTestResult(){this.down=new Array,this.up=new Array,this.pings=new Array}function RMBTPingResult(){}RMBTTestConfig.prototype.version="0.3",RMBTTestConfig.prototype.language=selectedLanguage,RMBTTestConfig.prototype.uuid="",RMBTTestConfig.prototype.type="DESKTOP",RMBTTestConfig.prototype.version_code="0.3",RMBTTestConfig.prototype.client_version="0.3",RMBTTestConfig.prototype.client_software_version="0.6.1",RMBTTestConfig.prototype.os_version=1,RMBTTestConfig.prototype.platform="RMBTws",RMBTTestConfig.prototype.model="Websocket",RMBTTestConfig.prototype.product="Chrome",RMBTTestConfig.prototype.client="RMBTws",RMBTTestConfig.prototype.timezone="Europe/Vienna",RMBTTestConfig.prototype.controlServerURL=controlProxy+"/"+wspath,RMBTTestConfig.prototype.controlServerRegistrationResource="/testRequest",RMBTTestConfig.prototype.controlServerResultResource="/result",RMBTTestConfig.prototype.controlServerDataCollectorResource="/requestDataCollector",RMBTTestConfig.prototype.pretestDurationMs=2e3,RMBTTestConfig.prototype.savedChunks=100,RMBTTestConfig.prototype.measurementPointsTimespan=40,RMBTTestConfig.prototype.fallbackBytesDownload=48,RMBTTestConfig.prototype.fallbackBytessUpload=48,RMBTTestConfig.prototype.numPings=10,RMBTTestConfig.prototype.limitUploadThreads=void 0===getParam||!1===getParam("allowUploadThreads"),RMBTTestConfig.prototype.userServerSelection=void 0!==window.userServerSelection?userServerSelection:0;var RMBTControlServerRegistrationResponse=function(){function t(t){this.client_remote_ip=t.client_remote_ip,this.provider=t.provider,this.test_server_encryption=t.test_server_encryption,this.test_numthreads=t.test_numthreads,this.test_server_name=t.test_server_name,this.test_uuid=t.test_uuid,this.test_id=t.test_id,this.test_token=t.test_token,this.test_server_address=t.test_server_address,this.test_duration=parseInt(t.test_duration),this.result_url=t.result_url,this.test_wait=t.test_wait,this.test_server_port=t.test_server_port}return t.prototype.client_remote_ip,t.prototype.provider,t.prototype.test_server_encryption="",t.prototype.test_numthreads,t.prototype.test_server_name,t.prototype.test_uuid,t.prototype.test_id,t.prototype.test_token,t.prototype.test_server_address,t.prototype.test_duration,t.prototype.result_url,t.prototype.test_wait,t.prototype.test_server_port,t}();RMBTTestResult.prototype.addThread=function(t){this.threads.push(t)},RMBTTestResult.prototype.ip_local,RMBTTestResult.prototype.ip_server,RMBTTestResult.prototype.port_remote,RMBTTestResult.prototype.num_threads,RMBTTestResult.prototype.encryption="NONE",RMBTTestResult.prototype.ping_shortest=-1,RMBTTestResult.prototype.ping_median=-1,RMBTTestResult.prototype.client_version,RMBTTestResult.prototype.pings=new Array,RMBTTestResult.prototype.speed_download=-1,RMBTTestResult.prototype.speed_upload=-1,RMBTTestResult.prototype.speedItems=new Array,RMBTTestResult.prototype.bytes_download=-1,RMBTTestResult.prototype.nsec_download=-1,RMBTTestResult.prototype.bytes_upload=-1,RMBTTestResult.prototype.nsec_upload=-1,RMBTTestResult.prototype.totalDownBytes=-1,RMBTTestResult.prototype.totalUpBytes=-1,RMBTTestResult.prototype.beginTime=-1,RMBTTestResult.prototype.geoLocations=new Array,RMBTTestResult.prototype.calculateAll=function(){for(var t=function(t,e){for(var s=t.length,o=1/0,r=0;r<s;r++){var n=e(t[r]);n.length>0&&n[n.length-1].duration<o&&(o=n[n.length-1].duration)}for(var i=0,r=0;r<s;r++){var p=t[r];if(null!==p&&e(p).length>0){for(var a=e(p).length,T=0;T<e(p).length;T++)if(e(p)[T].duration>o){a=T;break}var l;if(a===e(p).length)l=e(p)[e(p).length-1].bytes;else{var u=0===a?0:e(p)[a-1].bytes,d=e(p)[a].bytes,R=d-u,y=0===a?0:e(p)[a-1].duration,h=e(p)[a].duration,_=h-y,g=o-y,c=g/_,B=Math.round(R*c);B<0&&(B=0),l=u+B}i+=l}}return{bytes:i,nsec:o,speed:8*i/(o/1e9)/1e3}},e=0;e<this.threads.length;e++){var s=this.threads[e].down;if(s.length>0)for(var o=0;o<s.length;o++)this.speedItems.push({direction:"download",thread:e,time:s[o].duration,bytes:s[o].bytes})}var r=t(this.threads,function(t){return t.down});this.speed_download=r.speed,this.bytes_download=r.bytes,this.nsec_download=r.nsec;for(var e=0;e<this.threads.length;e++){var n=this.threads[e].up;if(n.length>0)for(var o=0;o<n.length;o++)this.speedItems.push({direction:"upload",thread:e,time:n[o].duration,bytes:n[o].bytes})}var r=t(this.threads,function(t){return t.up});this.speed_upload=r.speed,this.bytes_upload=r.bytes,this.nsec_upload=r.nsec;for(var i=this.threads[0].pings,p=1/0,e=0;e<i.length;e++)this.pings.push({value:i[e].client,value_server:i[e].server,time_ns:i[e].timeNs}),i[e].client<p&&(p=i[e].client);this.ping_shortest=p},RMBTThreadTestResult.prototype.down,RMBTThreadTestResult.prototype.up,RMBTThreadTestResult.prototype.pings,RMBTThreadTestResult.prototype.totalDownBytes=-1,RMBTThreadTestResult.prototype.totalUpBytes=-1,RMBTPingResult.prototype.client=-1,RMBTPingResult.prototype.server=-1,RMBTPingResult.prototype.timeNs=-1;var RMBTError={NOT_SUPPORTED:"WebSockets are not supported",SOCKET_INIT_FAILED:"WebSocket initialization failed",CONNECT_FAILED:"connecting to test server failed"};
