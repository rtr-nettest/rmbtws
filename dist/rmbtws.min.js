...
"use strict";function nowMs(){return performance.now()}function nowNs(){return Math.round(1e6*performance.now())}function CyclicBarrier(n){var e=n,o=[],r=function(){var n=o.slice();o=[],self.setTimeout(function(){for(var o=0;o<e;o++)n[o]()},1)};return{await:function(n){o.push(n),o.length===e&&r()}}}!function(){if(Date.now||(Date.now=function(){return(new Date).getTime()}),"undefined"==typeof performance&&(performance={}),!performance.now||void 0===performance.now){var n=Date.now();performance.timing&&performance.timing.navigationStart&&(n=performance.timing.navigationStart),performance.now=function(){return Date.now()-n}}}(),Math.median=function(n){n.sort(function(n,e){return n-e});var e=Math.floor(n.length/2);return n.length%2?n[e]:(n[e-1]+n[e])/2},Math.log10=Math.log10||function(n){return Math.log(n)/Math.LN10},self.log=self.log||{debug:function(){if(0==(void 0).level){var n;(n=console).debug.apply(n,arguments)}},trace:function(){(void 0).level<=1&&console.trace()},info:function(){if((void 0).level<=2){var n;(n=console).info.apply(n,arguments)}},warn:function(){if((void 0).level<=3){var n;(n=console).warn.apply(n,arguments)}},error:function(){if((void 0).level<=4){var n;(n=console).error.apply(n,arguments)}},setLevel:function(n){(void 0).level=n},getLogger:function(){return log}},"function"!=typeof Object.assign&&(Object.assign=function(n,e){if(null==n)throw new TypeError("Cannot convert undefined or null to object");for(var o=Object(n),r=1;r<arguments.length;r++){var t=arguments[r];if(null!=t)for(var i in t)Object.prototype.hasOwnProperty.call(t,i)&&(o[i]=t[i])}return o});
