...
export let RMBTTestConfig = (function () {
    ...
    RMBTTestConfig.prototype.client_version = ""; //filled out at runtime with the RMBT server version (from the server greeting)
    RMBTTestConfig.prototype.client_software_version = ""; //replaced at build time from the git tag by set-version.mjs (rmbtws library version)
