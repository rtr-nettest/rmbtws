...
export let RMBTTestConfig = (function () {
    ...
    RMBTTestConfig.prototype.client_version = "0.0.0-dev"; //replaced at build time from the git tag by set-version.mjs
    RMBTTestConfig.prototype.client_software_version = "0.9.6"; //filled out by version information from RMBTServer
